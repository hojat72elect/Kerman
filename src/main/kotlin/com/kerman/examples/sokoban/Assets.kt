...
import com.kerman.examples.sokoban.parallax.ParallaxBackground
import com.kerman.examples.sokoban.parallax.ParallaxLayer
import com.kerman.core.Kerman
import com.kerman.core.graphics.k2d.Animation
...
import com.kerman.core.maps.tiled.AtlasTmxMapLoader
import com.kerman.core.maps.tiled.TiledMap
import com.kerman.core.maps.tiled.TmxMapLoader
import com.kerman.core.math.Vector2
import com.kerman.core.scenes.scene2d.ui.TextButton.TextButtonStyle
...
object Assets {
    ...
    fun load() {
        atlas = TextureAtlas(Kerman.files.internal("data/atlasMap.txt"))

        font = BitmapFont(Kerman.files.internal("data/font32.fnt"), atlas!!.findRegion("UI/font32"))
        fontRed = BitmapFont(Kerman.files.internal("data/font32Red.fnt"), atlas!!.findRegion("UI/font32Red"))

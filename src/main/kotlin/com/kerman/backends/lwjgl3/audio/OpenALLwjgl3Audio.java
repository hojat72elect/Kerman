...
import com.kerman.core.utils.LongMap;
...
public class OpenALLwjgl3Audio implements Lwjgl3Audio {
    ...
    KermanArray<OpenALMusic> music = new KermanArray<>(false, 1, OpenALMusic[]::new);
    long device;
    long context;
    boolean noDevice = false;
    private KermanIntArray idleSources, allSources;
    ...
    public OpenALLwjgl3Audio(int simultaneousSources, int deviceBufferCount, int deviceBufferSize) {
        ...
        alGetError();
        allSources = new KermanIntArray(false, simultaneousSources);
        for (int i = 0; i < simultaneousSources; i++) {
            int sourceID = alGenSources();
            if (alGetError() != AL_NO_ERROR) break;
            allSources.add(sourceID);
        }
        idleSources = new KermanIntArray(allSources);
    ...
    public OpenALSound newSound(FileHandle file, String extension) {
        ...
        if (soundSupplier == null) throw new KermanRuntimeException("Unknown file extension for sound: " + file);
    ...
    public OpenALMusic newMusic(@NotNull FileHandle file) {
        ...
        if (musicSupplier == null) throw new KermanRuntimeException("Unknown file extension for music: " + file);

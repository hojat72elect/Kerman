    ...
    static public class Music extends OpenALMusic {
        ...
        public Music(OpenALLwjgl3Audio audio, FileHandle file) {
            ...
            try {
                ...
                if (header == null) throw new KermanRuntimeException("Empty MP3");
                int channels = header.mode() == Header.SINGLE_CHANNEL ? 1 : 2;
                outputBuffer = new OutputBuffer(channels, false);
                decoder.setOutputBuffer(outputBuffer);
                setup(channels, 16, header.getSampleRate());
            } catch (BitstreamException e) {
                throw new KermanRuntimeException("Error while preloading MP3", e);
            }
        }
        ...
        public int read(byte[] buffer) {
            try {
                ...
                reset();
                throw new KermanRuntimeException("Error reading audio data.", ex);
            }
        }

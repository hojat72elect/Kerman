...
public class OggInputStream extends InputStream {
    ...
    public OggInputStream(InputStream input, OggInputStream previousStream) {
        ...
        try {
            ...
            throw new KermanRuntimeException(ex);
        }
    ...
    private boolean getPageAndPacket() {
        ...
        try {
            ...
            throw new KermanRuntimeException("Failure reading Vorbis.", e);
        }
        ...
        if (syncState.pageout(page) != 1) {
            ...
            throw new KermanRuntimeException("Input does not appear to be an Ogg bitstream.");
        }
        ...
        if (streamState.pagein(page) < 0) {
            ...
            throw new KermanRuntimeException("Error reading first page of Ogg bitstream.");
        }

        if (streamState.packetout(packet) != 1) {
            // no page? must not be vorbis
            throw new KermanRuntimeException("Error reading initial header packet.");
        }

        if (oggInfo.synthesis_headerin(comment, packet) < 0) {
            // error case; not a vorbis header
            throw new KermanRuntimeException("Ogg bitstream does not contain Vorbis audio data.");
        }
        ...
        while (i < 2) {
                ...
                if (result == 1) {
                    ...
                    while (i < 2) {
                        ...
                        if (result == -1) {
                            ...
                            throw new KermanRuntimeException("Corrupt secondary header.");
                        }
            ...
            try {
                ...
                throw new KermanRuntimeException("Failed to read Vorbis.", e);
            }
            if (bytes == 0 && i < 2) {
                throw new KermanRuntimeException("End of file before finding all Vorbis headers.");
            }
            syncState.wrote(bytes);
        }
            ...
            while (!endOfBitStream) {
                while (!endOfBitStream) {
                    ...
                    if (result == 0) {
                        ...
                        Kerman.app.error("gdx-audio", "Error reading OGG: Corrupt or missing data in bitstream.");
                    } else {
                ...
                if (!endOfBitStream) {
                    ...
                    if (index >= 0) {
                        ...
                        try {
                            ...
                            throw new KermanRuntimeException("Error during Vorbis decoding.", e);
                        }
                    } else {
                        bytes = 0;
                    }

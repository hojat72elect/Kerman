    ...
    static int determineFormat(int channels, int bitDepth) { // @off
        ...
        switch (channels) {
            case 1:
                switch (bitDepth) {
                    ...
                    case 64:
                        ...
                        break;
                    default:
                        throw new KermanRuntimeException("Audio: Bit depth must be 8, 16, 32 or 64.");
                }
                break;
            ...
            case 8:
                ...
                break;
            default:
                throw new KermanRuntimeException("Audio: Invalid number of channels. " +
        ...
        if (channels >= 4) {
            if (bitDepth == 8) format--; // Use 8-bit AL_FORMAT instead
                ...
                throw new KermanRuntimeException("Audio: Bit depth must be 8, 16 or 32 when 4+ channels are present.");
        }
        return format; // @on
    }
}

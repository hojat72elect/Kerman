...
public abstract class OpenALMusic implements Music {
    ...
    private final KermanFloatArray renderedSecondsQueue = new KermanFloatArray(bufferCount);
        ...
        if (sourceID == -1) {
            ...
            if (buffers == null) {
                ...
                if (errorCode != AL_NO_ERROR)
                    throw new KermanRuntimeException("Unable to allocate audio buffers. AL Error: " + errorCode);
            }

...
class Lwjgl3GL20 implements com.kerman.core.graphics.GLES20 {
    ...
    private void ensureBufferCapacity(int numBytes) {
        if (buffer == null || buffer.capacity() < numBytes) {
            buffer = com.kerman.core.utils.BufferUtils.newByteBuffer(numBytes);
    ...
    public void glBufferSubData(int target, int offset, int size, Buffer data) {
        if (data == null)
            throw new KermanRuntimeException("Using null for the data not possible, blame LWJGL");
        else if (data instanceof ByteBuffer)
    ...
    public void glCompressedTexImage2D(int target, int level, int internalformat, int width, int height, int border,
        ...
        if (data instanceof ByteBuffer) {
            ...
            throw new KermanRuntimeException("Can't use " + data.getClass().getName() + " with this method. Use ByteBuffer instead.");
        }
    }

    public void glCompressedTexSubImage2D(int target, int level, int xoffset, int yoffset, int width, int height, int format,
                                          int imageSize, Buffer data) {
        throw new KermanRuntimeException("not implemented");
    }
    ...
    public void glDrawElements(int mode, int count, int type, Buffer indices) {
        if (indices instanceof ShortBuffer && type == com.kerman.core.graphics.GLES20.GL_UNSIGNED_SHORT) {
            ...
            sb.limit(oldLimit);
        } else if (indices instanceof ByteBuffer && type == com.kerman.core.graphics.GLES20.GL_UNSIGNED_SHORT) {
            ...
            GL11.glDrawElements(mode, sb);
            sb.limit(oldLimit);
        } else if (indices instanceof ByteBuffer && type == com.kerman.core.graphics.GLES20.GL_UNSIGNED_BYTE) {
            ...
            throw new KermanRuntimeException("Can't use " + indices.getClass().getName()
    ...
    public void glReadPixels(int x, int y, int width, int height, int format, int type, Buffer pixels) {
        if (pixels instanceof ByteBuffer)
            ...
            throw new KermanRuntimeException("Can't use " + pixels.getClass().getName()
    ...
    public void glVertexAttribPointer(int indx, int size, int type, boolean normalized, int stride, Buffer buffer) {
        if (buffer instanceof ByteBuffer) {
            if (type == GL_BYTE)
                ...
                throw new KermanRuntimeException("Can't use " + buffer.getClass().getName() + " with type " + type

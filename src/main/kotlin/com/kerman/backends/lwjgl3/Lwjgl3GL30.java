...
class Lwjgl3GL30 extends Lwjgl3GL20 implements com.kerman.core.graphics.GLES30 {
    @Override
    ...
    public void glDrawRangeElements(int mode, int start, int end, int count, int type, Buffer indices) {
        if (indices instanceof ByteBuffer)
            ...
            throw new KermanRuntimeException("indices must be byte, short or int buffer");
    }

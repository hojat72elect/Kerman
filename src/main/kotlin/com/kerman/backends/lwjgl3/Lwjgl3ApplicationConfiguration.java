...
import com.kerman.core.Graphics.DisplayMode;
import com.kerman.core.Graphics.Monitor;
import com.kerman.core.LifecycleListener;
import com.kerman.core.Preferences;
import com.kerman.core.audio.Music;
import com.kerman.backends.lwjgl3.Lwjgl3Graphics.Lwjgl3Monitor;
import com.kerman.core.graphics.GLES20;
import com.kerman.core.graphics.glutils.HdpiMode;
...
public class Lwjgl3ApplicationConfiguration extends Lwjgl3WindowConfiguration {
     ...
     * {@link HdpiMode} for more information. Note that some OpenGL functions like {@link GLES20#glViewport(int, int, int, int)} and
     * {@link GLES20#glScissor(int, int, int, int)} require raw pixel units. Use {@link HdpiUtils} to help with the conversion if

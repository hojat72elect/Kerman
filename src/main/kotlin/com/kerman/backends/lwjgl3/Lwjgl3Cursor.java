...
public class Lwjgl3Cursor implements Cursor {
    static final KermanArray<Lwjgl3Cursor> cursors = new KermanArray<>();
    ...
    Lwjgl3Cursor(Lwjgl3Window window, Pixmap pixmap, int xHotspot, int yHotspot) {
        ...
        if (pixmap.getFormat() != Pixmap.Format.RGBA8888) {
            throw new KermanRuntimeException("Cursor image pixmap is not in RGBA8888 format.");
        }
    ...
    static void setSystemCursor(long windowHandle, SystemCursor systemCursor) {
        ...
        if (glfwCursor == null) {
            ...
            if (systemCursor == SystemCursor.Arrow) {
                ...
                throw new KermanRuntimeException("Unknown system cursor " + systemCursor);
            }
    ...
    public void dispose() {
        if (pixmapCopy == null) {
            throw new KermanRuntimeException("Cursor already disposed");
        }

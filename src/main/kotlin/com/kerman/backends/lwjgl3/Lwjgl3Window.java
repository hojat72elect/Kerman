...
public class Lwjgl3Window implements Disposable {
    ...
    private final KermanArray<LifecycleListener> lifecycleListeners;
    ...
    Lwjgl3Window(ApplicationListener listener, KermanArray<LifecycleListener> lifecycleListeners, Lwjgl3ApplicationConfiguration config,
    ...
    static void setIcon(long windowHandle, String[] imagePaths, Files.FileType imageFileType) {
        ...
        for (int i = 0; i < imagePaths.length; i++) {
            pixmaps[i] = new Pixmap(Kerman.files.getFileHandle(imagePaths[i], imageFileType));
        }
    ...
    /**
     * Post a {@link Runnable} to this window's event queue. Use this if you access statics like {@link Kerman#graphics} in your
     ...
     *              32x32 and 48x48. Pixmap format {@link com.kerman.core.graphics.Pixmap.Format#RGBA8888 RGBA8888} is preferred so
    ...
    void makeCurrent() {
        Kerman.graphics = graphics;
        Kerman.gl32 = graphics.getGL32();
        Kerman.gl31 = Kerman.gl32 != null ? Kerman.gl32 : graphics.getGL31();
        Kerman.gl30 = Kerman.gl31 != null ? Kerman.gl31 : graphics.getGL30();
        Kerman.gl20 = Kerman.gl30 != null ? Kerman.gl30 : graphics.getGL20();
        Kerman.gl = Kerman.gl20;
        Kerman.input = input;

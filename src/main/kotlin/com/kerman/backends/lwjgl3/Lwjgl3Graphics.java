...
import com.kerman.core.AbstractGraphics;
import com.kerman.core.Application;
import com.kerman.core.graphics.Cursor;
import com.kerman.core.graphics.Cursor.SystemCursor;
...
public class Lwjgl3Graphics extends AbstractGraphics implements Disposable {
        ...
        if (window.getConfig().glEmulation == Lwjgl3ApplicationConfiguration.GLEmulation.GL32) {
            ...
            try {
                this.gl20 = window.getConfig().glEmulation == Lwjgl3ApplicationConfiguration.GLEmulation.GL20 ? new Lwjgl3GL20()
                        : (GLES20) Class.forName("com.badlogic.gdx.backends.lwjgl3.angle.Lwjgl3GLES20").newInstance();
            } catch (Throwable t) {
                throw new KermanRuntimeException("Couldn't instantiate GLES20.", t);
            }
            this.gl30 = null;
        }
        updateFramebufferInfo();
    ...
    @Override
    public GLES20 getGL20() {
        return gl20;
    }

    @Override
    public void setGL20(@NotNull GLES20 gl20) {
        this.gl20 = gl20;
    }

    @Override
    public GLES30 getGL30() {
        return gl30;
    }

    @Override
    public void setGL30(GLES30 gl30) {
        this.gl30 = gl30;
    }

    @Override
    public GLES31 getGL31() {
        return gl31;
    }

    @Override
    public void setGL31(@NotNull GLES31 gl31) {
        this.gl31 = gl31;
    }

    @Override
    public GLES32 getGL32() {
        return gl32;
    }

    @Override
    public void setGL32(@NotNull GLES32 gl32) {
        this.gl32 = gl32;
    }

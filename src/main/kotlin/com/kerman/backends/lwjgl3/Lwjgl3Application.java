...
import com.kerman.core.ApplicationListener;
import com.kerman.core.ApplicationLogger;
...
import com.kerman.core.LifecycleListener;
import com.kerman.core.Net;
import com.kerman.core.Preferences;
import com.kerman.backends.lwjgl3.Lwjgl3ApplicationConfiguration.GLEmulation;
import com.kerman.backends.lwjgl3.audio.Lwjgl3Audio;
import com.kerman.backends.lwjgl3.audio.OpenALLwjgl3Audio;
import com.kerman.backends.lwjgl3.audio.mock.MockAudio;
import com.kerman.core.graphics.glutils.GLVersion;
import com.kerman.core.math.GridPoint2;
...
public class Lwjgl3Application implements Lwjgl3ApplicationBase {
    ...
    final KermanArray<Lwjgl3Window> windows = new KermanArray<>();
    ...
    private final KermanArray<Runnable> runnables = new KermanArray<>();
    private final KermanArray<Runnable> executedRunnables = new KermanArray<>();
    private final KermanArray<LifecycleListener> lifecycleListeners = new KermanArray<>();
    ...
    public Lwjgl3Application(ApplicationListener listener, Lwjgl3ApplicationConfiguration config) {
        ...
        Kerman.audio = audio;
        this.files = Kerman.files = createFiles();
        this.net = Kerman.net = new Lwjgl3Net(config);
    ...
    static void initializeGlfw() {
        if (errorCallback == null) {
            ...
            if (!GLFW.glfwInit()) {
                throw new KermanRuntimeException("Unable to initialize GLFW");
            }
        }
    }
    ...
    static void loadANGLE() {
        try {
            ...
            throw new KermanRuntimeException("Couldn't load ANGLE.", t);
        }
    }
    ...
    static long createGlfwWindow(Lwjgl3ApplicationConfiguration config, long sharedContextWindow) {
        ...
        if (windowHandle == 0) {
            throw new KermanRuntimeException("Couldn't create window");
        }
        ...
        if (config.glEmulation == Lwjgl3ApplicationConfiguration.GLEmulation.ANGLE_GLES20) {
            try {
                ...
                throw new KermanRuntimeException("Couldn't initialize GLES", e);
            }
        } else {
        ...
        if (!glVersion.isVersionEqualToOrHigher(2, 0))
            throw new KermanRuntimeException("OpenGL 2.0 or higher with the FBO extension is required. OpenGL version: "
    ...
    private static void initiateGL(boolean useGLES20) {
        if (!useGLES20) {
            ...
            try {
                ...
                throw new KermanRuntimeException("Couldn't get GLES version string.", e);
            }
        }
    }
    ...
    protected void loop() {
        KermanArray<Lwjgl3Window> closedWindows = new KermanArray<>();

...
/**
 * Info : This interface was inspired by "com.badlogic.gdx.Files".
 *
...
interface Files {
     ...
     * @throws KermanRuntimeException if the type is classpath or internal and the file does not exist.
     */

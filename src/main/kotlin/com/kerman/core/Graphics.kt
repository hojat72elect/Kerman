...
/**
 * Info : This interface was inspired by "com.badlogic.gdx.Graphics".
 *
 ...
 * [Application] configuration, access to [GLES20] and [GLES30] are provided here.
 *
...
interface Graphics {
    /**
     * Returns whether OpenGL ES 3.0 is available. If it is you can get an instance of [GLES30] via [.getGL30] to
    ...
    /**
     * Returns whether OpenGL ES 3.1 is available. If it is you can get an instance of [GLES31] via [.getGL31] to
    ...
    /**
     * Returns whether OpenGL ES 3.2 is available. If it is you can get an instance of [GLES32] via [.getGL32] to
     ...
     */
    fun setGL20(gl20: GLES20)

    /**
     * @return the [GLES20] instance or null if not supported
     */
    fun getGL20(): GLES20?
     ...
     */
    fun setGL30(gl30: GLES30?)

    /**
     * @return the [GLES30] instance or null if not supported
     */
    fun getGL30(): GLES30?
     ...
     */
    fun setGL32(gl32: GLES32)

    /**
     * @return the [GLES32] instance or null if not supported
     */
    fun getGL32(): GLES32?

...
/**
 * Info : This class was inspired by "com.badlogic.gdx.math.Vector3".
 * <p>
 * Encapsulates a 3D vector. Allows chaining operations by returning a reference to itself in all modification functions.
 */
    ...
    public Vector3 fromString(String v) {
        ...
        if (s0 != -1 && s1 != -1 && v.charAt(0) == '(' && v.charAt(v.length() - 1) == ')') {
            try {
                ...
                // Throw a KermanRuntimeException
            }
        }
        throw new KermanRuntimeException("Malformed Vector3: " + v);
    }

...
import com.kerman.core.utils.KermanShortArray;

/**
 * Info : This class was inspired by "com.badlogic.gdx.math.EarClippingTriangulator".
 * <p>
...
public class EarClippingTriangulator {
    ...
    private final KermanShortArray indicesArray = new KermanShortArray();
    private final KermanIntArray vertexTypes = new KermanIntArray();
    private final KermanShortArray triangles = new KermanShortArray();
     ...
     */
    public KermanShortArray computeTriangles(KermanFloatArray vertices) {
     ...
     * @see #computeTriangles(float[], int, int)
     */
    public KermanShortArray computeTriangles(float[] vertices) {
     ...
     * method.
     */
    public KermanShortArray computeTriangles(float[] vertices, int offset, int count) {
        this.vertices = vertices;
        int vertexCount = this.vertexCount = count / 2;
        int vertexOffset = offset / 2;

        KermanShortArray indicesArray = this.indicesArray;
        indicesArray.clear();
        ...
        KermanIntArray vertexTypes = this.vertexTypes;
        vertexTypes.clear();
        ...
        KermanShortArray triangles = this.triangles;
        triangles.clear();

...
/**
 * Info : This class was inspired by "com.badlogic.gdx.math.Affine2".
 * <p>
...
public final class Affine2 implements Serializable {
     ...
     *
     * @return This matrix for the purpose of chaining operations.
     * @throws KermanRuntimeException if the matrix is singular (not invertible)
     */
    public Affine2 inv() {
        float det = det();
        if (det == 0) throw new KermanRuntimeException("Can't invert a singular affine matrix");

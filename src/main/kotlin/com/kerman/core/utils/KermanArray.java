...
import com.kerman.core.utils.reflect.ArrayReflection;
...
/**
 * This class was inspired by "com.badlogic.gdx.utils.Array".
 * <p>
 * A resizable, ordered or unordered array of objects. If unordered, this class avoids a memory copy when removing elements (the
 * last element is moved to the removed element's position).
 */
public class KermanArray<T> implements Iterable<T> {
    /**
     * Provides direct access to the underlying array. If the Array's generic type is not Object, this field may only be accessed
     * if the {@link KermanArray#KermanArray(boolean, int, Class)} constructor was used.
     */
    public T[] items;
     ...
     */
    public KermanArray(int capacity) {
        this(true, capacity);
    }
     ...
     */
    public KermanArray(boolean ordered, int capacity) {
     ...
     * @param capacity Any elements added beyond this will cause the backing array to be grown.
     */
    public KermanArray(boolean ordered, int capacity, ArraySupplier<T[]> arraySupplier) {
     ...
     */
    public KermanArray(ArraySupplier<T[]> arraySupplier) {
     ...
     *                 memory copy.
     * @param capacity Any elements added beyond this will cause the backing array to be grown.
     * @deprecated Use {@link KermanArray#KermanArray(boolean, int, ArraySupplier)} instead
     */
    @Deprecated
    public KermanArray(boolean ordered, int capacity, Class arrayType) {
     ...
     *
     * @deprecated Use {@link KermanArray#KermanArray(ArraySupplier)} instead
     */
    @Deprecated
    public KermanArray(Class arrayType) {
     ...
     */
    public KermanArray(KermanArray<? extends T> array) {
     ...
     *                memory copy.
     */
    public KermanArray(boolean ordered, T[] array, int start, int count) {
    ...
    /**
     * @see #KermanArray(ArraySupplier)
     */
    static public <T> KermanArray<T> of(ArraySupplier<T[]> arraySupplier) {
        return new KermanArray<>(arraySupplier);
    }

    /**
     * @see #KermanArray(boolean, int, ArraySupplier)
     */
    static public <T> KermanArray<T> of(boolean ordered, int capacity, ArraySupplier<T[]> arraySupplier) {
        return new KermanArray<>(ordered, capacity, arraySupplier);
    }

    /**
     * @see #KermanArray(Class)
     * @deprecated Use {@link KermanArray#of(ArraySupplier)}
     */
    @Deprecated
    static public <T> KermanArray<T> of(Class<T> arrayType) {
        return new KermanArray<>(arrayType);
    }

    /**
     * @see #KermanArray(boolean, int, Class)
     * @deprecated Use {@link KermanArray#of(boolean, int, ArraySupplier)}
     */
    @Deprecated
    static public <T> KermanArray<T> of(boolean ordered, int capacity, Class<T> arrayType) {
        return new KermanArray(ordered, capacity, arrayType);
    }

    /**
     * @see #KermanArray(Object[])
     */
    static public <T> KermanArray<T> with(T... array) {
        return new KermanArray(array);
    }
    ...
    public void addAll(KermanArray<? extends T> array) {
        addAll(array.items, 0, array.size);
    }

    public void addAll(KermanArray<? extends T> array, int start, int count) {
     ...
     * @param identity If true, == comparison will be used. If false, .equals() comparison will be used.
     */
    public boolean containsAll(KermanArray<? extends T> values, boolean identity) {
     ...
     * @param identity If true, == comparison will be used. If false, .equals() comparison will be used.
     */
    public boolean containsAny(KermanArray<? extends T> values, boolean identity) {
        T[] items = values.items;
        for (int i = 0, n = values.size; i < n; i++)
     ...
     */
    public boolean removeAll(KermanArray<? extends T> array, boolean identity) {
        int size = this.size;
        int startSize = size;
        T[] items = this.items;
        if (identity) {
     ...
     * array must have a size greater than 0, or a {@link com.kerman.core.utils.KermanRuntimeException} will be thrown.
     *
    ...
    public T selectRanked(Comparator<T> comparator, int kthLowest) {
        if (kthLowest < 1) {
            throw new KermanRuntimeException("nth_lowest must be greater than 0, 1 = first, 2 = second...");
        }
     ...
     * @see KermanArray#selectRanked(Comparator, int)
     */
    ...
    /**
     * Returns the items as an array. Note the array is typed, so the {@link #KermanArray(Class)} constructor must have been used.
    ...
    /**
     * @deprecated Use {@link KermanArray#toArray(ArraySupplier)} instead
     */
    @Deprecated
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof KermanArray)) return false;
        KermanArray array = (KermanArray) object;
    ...
    static public class ArrayIterator<T> implements Iterator<T>, Iterable<T> {
        private final KermanArray<T> array;
        private final boolean allowRemove;
        int index;
        boolean valid = true;


        public ArrayIterator(KermanArray<T> array) {
            this(array, true);
        }

        public ArrayIterator(KermanArray<T> array, boolean allowRemove) {
            this.array = array;
        ...
        public boolean hasNext() {
            if (!valid) {
                throw new KermanRuntimeException("#iterator() cannot be used nested.");
            }
        ...
        public void remove() {
            if (!allowRemove) throw new KermanRuntimeException("Remove not allowed.");
            index--;
    ...
    static public class ArrayIterable<T> implements Iterable<T> {
        ...
        public ArrayIterable(KermanArray<T> array) {
            this(array, true);
        }

        public ArrayIterable(KermanArray<T> array, boolean allowRemove) {
            this.array = array;
            this.allowRemove = allowRemove;
        }

...
/**
 * Info : This class was inspired by "com.badlogic.gdx.utils.XmlReader".
 * <p>
...
public class XmlReader {
    ...
    private final KermanArray<Element> elements = new KermanArray<>(8);
    ...
    static public class Element {
        ...
        private KermanArray<Element> children;
        private String text;
        ...
        /**
         * @throws KermanRuntimeException if the attribute was not found.
         */
        public String getAttribute(String name) {
            if (attributes == null)
                throw new KermanRuntimeException("Element " + this.name + " doesn't have attribute: " + name);
        ...
        public KermanArray<Element> getChildren() {
            return children;
        }

        /**
         * @throws KermanRuntimeException if the element has no children.
         */
        public Element getChild(int index) {
            if (children == null) throw new KermanRuntimeException("Element has no children: " + name);
            return children.get(index);
        }

        public void addChild(Element element) {
            if (children == null) children = new KermanArray<>(8);
        ...
        public void replaceChild(Element child, Element replacement) {
            ...
            if (!children.replaceFirst(child, true, replacement)) {
                throw new KermanRuntimeException("Element '" + name + "' does not contain child: " + child);
            }
        }
         ...
         * @return the children with the given name or an empty {@link KermanArray}
         */
        public KermanArray<Element> getChildrenByName(String name) {
            KermanArray<Element> result = new KermanArray<Element>();
         ...
         * @return the children with the given name or an empty {@link KermanArray}
         */
        public KermanArray<Element> getChildrenByNameRecursively(String name) {
            KermanArray<Element> result = new KermanArray<Element>();
            getChildrenByNameRecursively(name, result);
            return result;
        }

        private void getChildrenByNameRecursively(String name, KermanArray<Element> result) {
         ...
         *
         * @throws KermanRuntimeException if no attribute or child was not found.
         */
        public String get(String name) {
            String value = get(name, null);
            if (value == null)
                throw new KermanRuntimeException("Element " + this.name + " doesn't have attribute or child: " + name);
            return value;
        }

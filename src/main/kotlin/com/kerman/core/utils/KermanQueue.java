 ...
 */
public class KermanQueue<T> implements Iterable<T> {
    /**
     ...
     */
    public KermanQueue(int initialSize) {
     ...
     *
     * @deprecated Use {@link KermanQueue#KermanQueue(int, ArraySupplier)} instead
     */
    @Deprecated
    public KermanQueue(int initialSize, Class<T> type) {
     ...
     */
    public KermanQueue(int initialSize, ArraySupplier<T[]> arraySupplier) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof KermanQueue)) return false;

        KermanQueue<?> q = (KermanQueue<?>) o;
        final int size = this.size;
    ...
    static public class QueueIterator<T> implements Iterator<T>, Iterable<T> {
        private final KermanQueue<T> queue;
        private final boolean allowRemove;
        int index;
        boolean valid = true;

        public QueueIterator(KermanQueue<T> queue) {
            this(queue, true);
        }

        public QueueIterator(KermanQueue<T> queue, boolean allowRemove) {
            this.queue = queue;
    ...
    static public class QueueIterable<T> implements Iterable<T> {
        ...
        public QueueIterable(KermanQueue<T> queue) {
            this(queue, true);
        }

        public QueueIterable(KermanQueue<T> queue, boolean allowRemove) {
            this.queue = queue;
            this.allowRemove = allowRemove;
        }

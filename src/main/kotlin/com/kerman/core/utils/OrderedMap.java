...
/**
 * Info : This class was inspired by "com.badlogic.gdx.utils.OrderedMap".
 * <p>
 * An {@link ObjectMap} that also stores keys in an {@link KermanArray} using the insertion order. Null keys are not allowed. No
 ...
 * reduced by setting {@link KermanArray#ordered} to false for {@link OrderedMap#orderedKeys()}.
 * <p>
...
public class OrderedMap<K, V> extends ObjectMap<K, V> {
    final KermanArray<K> keys;

    /**
     * Creates a new map with an initial capacity of 51 and a load factor of 0.8.
     */
    public OrderedMap() {
        keys = new KermanArray<>();
    }
    ...
    public OrderedMap(int initialCapacity) {
        ...
        keys = new KermanArray<>(initialCapacity);
    }
    ...
    public KermanArray<K> orderedKeys() {
        return keys;
    }
    ...
    static public class OrderedMapEntries<K, V> extends Entries<K, V> {
        private final KermanArray<K> keys;
        ...
        public Entry next() {
            ...
            if (!valid) throw new KermanRuntimeException("#iterator() cannot be used nested.");
    ...
    static public class OrderedMapKeys<K> extends Keys<K> {
        ...
        public KermanArray<K> toArray(KermanArray<K> array) {
        ...
        public KermanArray<K> toArray() {
            return toArray(new KermanArray<>(true, keys.size - nextIndex));
        }
    }

    static public class OrderedMapValues<V> extends Values<V> {
        private final KermanArray keys;
        ...
        public KermanArray<V> toArray(KermanArray<V> array) {
            int n = keys.size;

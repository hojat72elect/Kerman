...
/**
 * This class was inspired by "com.badlogic.gdx.utils.FloatArray".
 * <p>
...
public class KermanFloatArray {
     ...
     */
    public KermanFloatArray(int capacity) {
        this(true, capacity);
    }
     ...
     */
    public KermanFloatArray(boolean ordered, int capacity) {
     ...
     * grown.
     */
    public KermanFloatArray(KermanFloatArray array) {
     ...
     */
    public KermanFloatArray(float[] array) {
     ...
     *                memory copy.
     */
    public KermanFloatArray(boolean ordered, float[] array, int startIndex, int count) {
        this(ordered, count);
        size = count;
    ...
    /**
     * @see #KermanFloatArray(float[])
     */
    static public KermanFloatArray with(float... array) {
        return new KermanFloatArray(array);
    }
    ...
    public void addAll(KermanFloatArray array) {
        addAll(array.items, 0, array.size);
    }

    public void addAll(KermanFloatArray array, int offset, int length) {
     ...
     */
    public boolean removeAll(KermanFloatArray array) {
        int size = this.size;
        int startSize = size;
        float[] items = this.items;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof KermanFloatArray)) return false;
        KermanFloatArray array = (KermanFloatArray) object;

...
/**
 * Info : This class was inspired by "com.badlogic.gdx.utils.DelayedRemovalArray".
 * <p>
 ...
 * problem.
 */
public class DelayedRemovalArray<T> extends KermanArray<T> {
    private int iterating;
    private final KermanIntArray remove = new KermanIntArray(0);
    private int clear;
    ...
    public DelayedRemovalArray(KermanArray array) {
        super(array);
    }

...
/**
 * Info : This abstract class was inspired by "com.badlogic.gdx.utils.viewport.Viewport".
 * <p>
...
public abstract class Viewport {
    ...
    public Vector2 toScreenCoordinates(Vector2 worldCoords, Matrix4 transformMatrix) {
        ...
        camera.project(tmp, screenX, screenY, screenWidth, screenHeight);
        tmp.y = Kerman.graphics.getHeight() - tmp.y;
        worldCoords.x = tmp.x;
        worldCoords.y = tmp.y;
        return worldCoords;
    }
    ...
    public int getRightGutterWidth() {
        return Kerman.graphics.getWidth() - (screenX + screenWidth);
    }
    ...
    public int getTopGutterHeight() {
        return Kerman.graphics.getHeight() - (screenY + screenHeight);
    }
}

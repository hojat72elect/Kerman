...
/**
 * This class was inspired by the "com.badlogic.gdx.utils.ArrayMap".
 * <p>
 ...
 * makes iteration fast. Like {@link KermanArray}, if ordered is false, this class avoids a memory copy when removing elements (the last
...
public class ArrayMap<K, V> implements Iterable<ObjectMap.Entry<K, V>> {
    ...
    static public class Values<V> implements Iterable<V>, Iterator<V> {
        ...
        public KermanArray<V> toArray() {
            return new KermanArray(true, map.values, index, map.size - index);
        }

        public KermanArray<V> toArray(KermanArray array) {
    ...
    static public class Keys<K> implements Iterable<K>, Iterator<K> {
        ...
        public KermanArray<K> toArray() {
            return new KermanArray<>(true, map.keys, index, map.size - index);
        }

        public KermanArray<K> toArray(KermanArray array) {

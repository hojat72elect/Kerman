...
/**
 * Info : This class was inspired by "com.badlogic.gdx.utils.ShortArray".
 * <p>
...
public class KermanShortArray {
     ...
     */
    public KermanShortArray(int capacity) {
        this(true, capacity);
    }
     ...
     */
    public KermanShortArray(boolean ordered, int capacity) {
     ...
     * grown.
     */
    public KermanShortArray(KermanShortArray array) {
     ...
     */
    public KermanShortArray(short[] array) {
     ...
     *                memory copy.
     */
    public KermanShortArray(boolean ordered, short[] array, int startIndex, int count) {
        this(ordered, count);
        size = count;
    ...
    /**
     * @see #KermanShortArray(short[])
     */
    static public KermanShortArray with(short... array) {
        return new KermanShortArray(array);
    }
    ...
    public void addAll(KermanShortArray array) {
        addAll(array.items, 0, array.size);
    }

    public void addAll(KermanShortArray array, int offset, int length) {
     ...
     */
    public boolean removeAll(KermanShortArray array) {
        int size = this.size;
        int startSize = size;
        short[] items = this.items;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof KermanShortArray)) return false;
        KermanShortArray array = (KermanShortArray) object;

...
/**
 * Info : This class was inspired by "com.badlogic.gdx.utils.IntArray".
 * <p>
...
public class KermanIntArray {
     ...
     */
    public KermanIntArray(int capacity) {
        this(true, capacity);
    }
     ...
     */
    public KermanIntArray(boolean ordered, int capacity) {
     ...
     * grown.
     */
    public KermanIntArray(KermanIntArray array) {
     ...
     */
    public KermanIntArray(int[] array) {
     ...
     *                memory copy.
     */
    public KermanIntArray(boolean ordered, int[] array, int startIndex, int count) {
        this(ordered, count);
        size = count;
    ...
    /**
     * @see #KermanIntArray(int[])
     */
    static public KermanIntArray with(int... array) {
        return new KermanIntArray(array);
    }
    ...
    public void addAll(KermanIntArray array) {
        addAll(array.items, 0, array.size);
    }

    public void addAll(KermanIntArray array, int offset, int length) {
     ...
     */
    public boolean removeAll(KermanIntArray array) {
        int size = this.size;
        int startSize = size;
        int[] items = this.items;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof KermanIntArray)) return false;
        KermanIntArray array = (KermanIntArray) object;

...
/**
 * Info : This class was inspired by "com.badlogic.gdx.utils.JsonValue".
 * <p>
...
public class JsonValue implements Iterable<JsonValue> {
    ...
    private JsonValue(JsonValue other, @Nullable JsonValue otherLast, @Nullable JsonValue parent) {
        type = other.type;
     ...
     * @return May be null.
     */
    public @Nullable JsonValue getIgnoreCase(String name) {
        JsonValue current = child;
     ...
     * @return May be null.
     */
    public @Nullable JsonValue last() {
        return last;
    }

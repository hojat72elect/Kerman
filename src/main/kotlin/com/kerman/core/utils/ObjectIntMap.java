...
/**
 * Info : This class was inspired by "com.badlogic.gdx.utils.ObjectIntMap".
 * <p>
...
public class ObjectIntMap<K> implements Iterable<ObjectIntMap.Entry<K>> {
    ...
    static public class Values extends MapIterator<Object> {
         ...
         */
        public KermanIntArray toArray() {
            KermanIntArray array = new KermanIntArray(true, map.size);
            while (hasNext)
                array.add(next());
            return array;
        }
         ...
         */
        public KermanIntArray toArray(KermanIntArray array) {
            while (hasNext)
                array.add(next());
            return array;
        }

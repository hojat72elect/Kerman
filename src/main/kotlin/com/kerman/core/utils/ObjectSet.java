...
/**
 * Info : This class was inspired by "com.badlogic.gdx.utils.ObjectSet".
 * <p>
...
public class ObjectSet<T> implements Iterable<T> {
    ...
    public void addAll(KermanArray<? extends T> array, int offset, int length) {
    ...
    static public class ObjectSetIterator<K> implements Iterable<K>, Iterator<K> {
        ...
        public KermanArray<K> toArray() {
            return toArray(new KermanArray<K>(true, set.size));
        }
    }
}

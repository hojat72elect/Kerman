...
/**
 * Info : This class was inspired by "com.badlogic.gdx.utils.ByteArray".
 * <p>
...
public class KermanByteArray {
     ...
     */
    public KermanByteArray(int capacity) {
        this(true, capacity);
    }
     ...
     */
    public KermanByteArray(boolean ordered, int capacity) {
     ...
     * grown.
     */
    public KermanByteArray(KermanByteArray array) {
     ...
     */
    public KermanByteArray(byte[] array) {
     ...
     *                memory copy.
     */
    public KermanByteArray(boolean ordered, byte[] array, int startIndex, int count) {
        this(ordered, count);
        size = count;
    ...
    /**
     * @see #KermanByteArray(byte[])
     */
    static public KermanByteArray with(byte... array) {
        return new KermanByteArray(array);
    }
    ...
    public void addAll(KermanByteArray array) {
        addAll(array.items, 0, array.size);
    }

    public void addAll(KermanByteArray array, int offset, int length) {
     ...
     */
    public boolean removeAll(KermanByteArray array) {
        int size = this.size;
        int startSize = size;
        byte[] items = this.items;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof KermanByteArray)) return false;
        KermanByteArray array = (KermanByteArray) object;

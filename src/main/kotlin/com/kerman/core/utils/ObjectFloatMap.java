...
import static com.kerman.core.utils.ObjectSet.tableSize;

/**
 * Info : This class was inspired by "com.badlogic.gdx.utils.ObjectFloatMap".
 * <p>
...
public class ObjectFloatMap<K> implements Iterable<ObjectFloatMap.Entry<K>> {
    ...
    static public class Values extends MapIterator<Object> {
         ...
         */
        public KermanFloatArray toArray() {
            KermanFloatArray array = new KermanFloatArray(true, map.size);
            while (hasNext)
                array.add(next());
            return array;
        }
         ...
         */
        public KermanFloatArray toArray(KermanFloatArray array) {
            while (hasNext)
                array.add(next());
            return array;
        }
    ...
    static public class Keys<K> extends MapIterator<K> implements Iterable<K>, Iterator<K> {
        ...
        public KermanArray<K> toArray() {
            return toArray(new KermanArray<K>(true, map.size));
        }

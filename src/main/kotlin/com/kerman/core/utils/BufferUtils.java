...
/**
 * Info : This class was inspired by "com.badlogic.gdx.utils.BufferUtils". But I have to change its logic slightly, because I don't want to have C++ code in my engine.
 * <p>
 * Class with static helper methods to increase the speed of array/direct buffer and direct buffer/direct buffer transfers.
 */
public final class BufferUtils {

    static KermanArray<ByteBuffer> unsafeBuffers = new KermanArray<>();
    ...
    private static int positionInBytes(Buffer dst) {
        if (dst instanceof ByteBuffer)
            ...
            throw new KermanRuntimeException("Can't copy to a " + dst.getClass().getName() + " instance");
    }

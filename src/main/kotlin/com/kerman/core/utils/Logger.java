...
/**
 * Info : This class was inspired by the "com.badlogic.gdx.utils.Logger".
 * <p>
...
public class Logger {
    ...
    public void debug(String message) {
        if (level >= DEBUG) Kerman.app.debug(tag, message);
    }

    public void debug(String message, Exception exception) {
        if (level >= DEBUG) Kerman.app.debug(tag, message, exception);
    }

    public void info(String message) {
        if (level >= INFO) Kerman.app.log(tag, message);
    }

    public void info(String message, Exception exception) {
        if (level >= INFO) Kerman.app.log(tag, message, exception);
    }

    public void error(String message) {
        if (level >= ERROR) Kerman.app.error(tag, message);
    }

    public void error(String message, Throwable exception) {
        if (level >= ERROR) Kerman.app.error(tag, message, exception);
    }

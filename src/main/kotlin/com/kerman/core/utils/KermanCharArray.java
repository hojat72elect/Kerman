...
/**
 * Info : This class was inspired by "com.badlogic.gdx.utils.CharArray".
 * <p>
 ...
 * </ul>
 */
public class KermanCharArray implements CharSequence, Appendable {
     ...
     */
    public KermanCharArray(int capacity) {
        this(true, capacity);
    }
     ...
     */
    public KermanCharArray(boolean ordered, int capacity) {
     ...
     * grown.
     */
    public KermanCharArray(KermanCharArray array) {
     ...
     */
    public KermanCharArray(char[] array) {
     ...
     *                memory copy.
     */
    public KermanCharArray(boolean ordered, char[] array, int start, int count) {
        this(ordered, count);
        size = count;
     ...
     */
    public KermanCharArray(CharSequence seq) {
     ...
     */
    public KermanCharArray(String str) {
     ...
     */
    public KermanCharArray(StringBuilder str) {
        this(str.length() + CAPACITY);
        append(str);
    }
     ...
     */
    private KermanCharArray(char[] initialBuffer, int length) {
     ...
     */
    static public KermanCharArray wrap(char[] initialBuffer) {
        return new KermanCharArray(initialBuffer, initialBuffer.length);
    }
     ...
     * @return A new instance.
     */
    static public KermanCharArray wrap(char[] initialBuffer, int length) {
        return new KermanCharArray(initialBuffer, length);
    }

    /**
     * @see #KermanCharArray(char[])
     */
    static public KermanCharArray with(char... array) {
        return new KermanCharArray(array);
    }
    ...
    public void addAll(KermanCharArray array) {
        addAll(array.items, 0, array.size);
    }

    public void addAll(KermanCharArray array, int offset, int length) {
     ...
     */
    public boolean removeAll(KermanCharArray array) {
        int size = this.size;
        int startSize = size;
        char[] items = this.items;
     ...
     */
    public KermanCharArray append(boolean value) {
        if (value) {
     ...
     */
    public KermanCharArray append(char value) {
        require(1);
        items[size++] = value;
        return this;
    }
     ...
     */
    public KermanCharArray append(@Nullable char[] ch) {
     ...
     */
    public KermanCharArray append(@Nullable char[] ch, int start, int length) {
        if (ch == null) return appendNull();
     ...
     */
    public KermanCharArray append(@Nullable CharBuffer str) {
        if (str == null)
            appendNull();
        else
     ...
     */
    public KermanCharArray append(@Nullable CharBuffer buf, int start, int end) {
     ...
     */
    public KermanCharArray append(@Nullable CharSequence seq) {
        if (seq == null) return appendNull();
        if (seq instanceof KermanCharArray) return append((KermanCharArray) seq);
     ...
     * @param end   the end index, exclusive
     */
    public KermanCharArray append(@Nullable CharSequence seq, int start, int end) {
        if (seq == null) return appendNull();
     ...
     */
    public KermanCharArray append(double value) {
     ...
     */
    public KermanCharArray append(float value) {
        return append(String.valueOf(value));
    }
     ...
     */
    public KermanCharArray append(int value) {
     ...
     */
    public KermanCharArray append(int value, int minLength) {
     ...
     */
    public KermanCharArray append(int value, final int minLength, final char prefix) {
     ...
     */
    public KermanCharArray append(long value) {
        return append(value, 0, '0');
    }
     ...
     * @param minLength the minimum number of characters to add
     */
    public KermanCharArray append(long value, int minLength) {
        return append(value, minLength, '0');
    }
     ...
     * @param prefix    the character to use as prefix
     */
    public KermanCharArray append(long value, int minLength, char prefix) {
     ...
     */
    public KermanCharArray append(@Nullable Object obj) {
     ...
     */
    public KermanCharArray append(@Nullable String str) {
        if (str == null)
            appendNull();
        else {
     ...
     */
    public KermanCharArray append(String str, String separator) {
     ...
     */
    public KermanCharArray append(@Nullable String str, int start, int end) {
     ...
     */
    public KermanCharArray append(@Nullable StringBuffer str) {
        if (str == null)
            appendNull();
        else
            append(str, 0, str.length());
     ...
     * @param end   the end index, exclusive
     */
    public KermanCharArray append(@Nullable StringBuffer str, int start, int end) {
        if (str == null) return appendNull();
        if (start < 0 || end < 0 || start > end || end > str.length()) throw new IndexOutOfBoundsException();
        int length = end - start;
        if (length > 0) {
     ...
     */
    public KermanCharArray append(@Nullable StringBuilder str) {
        if (str == null)
            appendNull();
        else
            append(str, 0, str.length());
     ...
     * @param end   the end index, exclusive
     */
    public KermanCharArray append(@Nullable StringBuilder str, int start, int end) {
        if (str == null) return appendNull();
        if (start < 0 || end < 0 || start > end || end > str.length()) throw new IndexOutOfBoundsException();
        int length = end - start;
        if (length > 0) {
     ...
     */
    public KermanCharArray append(@Nullable KermanCharArray str) {
        if (str == null)
            appendNull();
        else
     ...
     * @param end   the end index, exclusive
     */
    public KermanCharArray append(@Nullable KermanCharArray str, int start, int end) {
        if (str == null) return appendNull();
     ...
     * {@link #append(Object)}.
     */
    public KermanCharArray appendAll(Iterable<?> iterable) {
     ...
     * {@link #append(Object)}.
     */
    public KermanCharArray appendAll(Iterator<?> iter) {
        while (iter.hasNext())
            append(iter.next());
        return this;
    }
     ...
     * {@link #append(Object)}.
     */
    public final <T> KermanCharArray appendAll(T... array) {
        if (array != null) {
     ...
     */
    public KermanCharArray appendFixedWidthPadLeft(int value, int width, char padChar) {
     ...
     * @param width the fixed field width, zero or negative has no effect
     */
    public KermanCharArray appendFixedWidthPadLeft(@Nullable Object obj, int width, char padChar) {
        if (width > 0) {
            require(width);
     ...
     * @param width the fixed field width, zero or negative has no effect
     */
    public KermanCharArray appendFixedWidthPadRight(int value, int width, char padChar) {
     ...
     * @param width the fixed field width, zero or negative has no effect
     */
    public KermanCharArray appendFixedWidthPadRight(@Nullable Object obj, int width, char padChar) {
        if (width > 0) {
            require(width);
            String str = Objects.toString(obj, NULL);
            int strLength = str.length();
     ...
     */
    public KermanCharArray appendln(boolean value) {
     ...
     */
    public KermanCharArray appendln(char ch) {
     ...
     */
    public KermanCharArray appendln(@Nullable char[] ch) {
        return append(ch).appendLine();
    }
     ...
     * @param start the start index, inclusive
     */
    public KermanCharArray appendln(@Nullable char[] ch, int start, int length) {
     ...
     */
    public KermanCharArray appendln(double value) {
        return append(value).appendLine();
    }
     ...
     */
    public KermanCharArray appendln(float value) {
        return append(value).appendLine();
    }
     ...
     */
    public KermanCharArray appendln(int value) {
        return append(value).appendLine();
    }
     ...
     */
    public KermanCharArray appendln(long value) {
        return append(value).appendLine();
    }
     ...
     */
    public KermanCharArray appendln(@Nullable Object obj) {
     ...
     */
    public KermanCharArray appendln(@Nullable String str) {
        append(str);
        return append('\n');
    }
     ...
     * Appends a string followed by a new line to this CharArray. Appending null will call {@link #appendNull()}.
     */
    public KermanCharArray appendLine(@Nullable String str) {
        append(str);
        return append('\n');
    }
     ...
     * @param end   the end index, exclusive
     */
    public KermanCharArray appendln(@Nullable String str, int start, int end) {
     ...
     */
    public KermanCharArray appendln(@Nullable StringBuffer str) {
     ...
     * @param end   the end index, exclusive
     */
    public KermanCharArray appendln(@Nullable StringBuffer str, int start, int end) {
        return append(str, start, end).appendLine();
    }
     ...
     */
    public KermanCharArray appendln(@Nullable StringBuilder str) {
        return append(str).appendLine();
    }
     ...
     * @param end   the end index, exclusive
     */
    public KermanCharArray appendln(@Nullable StringBuilder str, int start, int end) {
        return append(str, start, end).appendLine();
    }
     ...
     */
    public KermanCharArray appendln(@Nullable KermanCharArray str) {
        return append(str).appendLine();
    }
     ...
     * @param end   the end index, exclusive
     */
    public KermanCharArray appendln(@Nullable KermanCharArray str, int start, int end) {
        return append(str, start, end).appendLine();
    }
     ...
     * Appends {@code \n}.
     */
    public KermanCharArray appendln() {
        return append('\n');
    }
     ...
     * Appends {@code \n}.
     */
    public KermanCharArray appendLine() {
        return append('\n');
    }
     ...
     * Appends {@code "null"}.
     */
    public KermanCharArray appendNull() {
        require(4);
        int length = size;
        items[length] = 'n';
        items[length + 1] = 'u';
     ...
     */
    public KermanCharArray appendPadding(int padCount, char padChar) {
        if (padCount > 0) {
            require(padCount);
     ...
     */
    public KermanCharArray appendSeparator(char separator) {
     ...
     */
    public KermanCharArray appendSeparator(char standard, char defaultIfEmpty) {
        if (isEmpty())
     ...
     * Note that for this simple example, you should use {@link #appendWithSeparators(Iterable, String)}.
     */
    public KermanCharArray appendSeparator(char separator, int loopIndex) {
     ...
     */
    public KermanCharArray appendSeparator(@Nullable String separator) {
     ...
     * @param separator the separator to use, null means no separator
     */
    public KermanCharArray appendSeparator(@Nullable String separator, int loopIndex) {
     ...
     */
    public KermanCharArray appendSeparator(@Nullable String standard, @Nullable String defaultIfEmpty) {
     ...
     * @param separator the separator to use, null means no separator
     */
    public KermanCharArray appendWithSeparators(Iterable<?> iterable, @Nullable String separator) {
     ...
     * @param separator the separator to use, null means no separator
     */
    public KermanCharArray appendWithSeparators(Iterator<?> it, @Nullable String separator) {
     ...
     * @param separator the separator to use, null means no separator
     */
    public KermanCharArray appendWithSeparators(Object[] array, @Nullable String separator) {
        if (array.length > 0) {
            String sep = Objects.toString(separator, "");
            append(array[0]);
     ...
     */
    public KermanCharArray appendCodePoint(int codePoint) {
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public KermanCharArray delete(int start, int end) {
     ...
     */
    public KermanCharArray deleteAll(char ch) {
     ...
     */
    public KermanCharArray deleteAll(String str) {
     ...
     * @see #setCharAt(int, char)
     */
    public KermanCharArray deleteCharAt(int index) {
        validateIndex(index);
     ...
     * Deletes the character wherever it occurs in the CharArray.
     */
    public KermanCharArray deleteFirst(char ch) {
        for (int i = 0; i < size; i++) {
            if (items[i] == ch) {
                delete(i, i + 1, 1);
                break;
     ...
     * Deletes the string wherever it occurs in the CharArray.
     */
    public KermanCharArray deleteFirst(String str) {
        if (str == null) throw new IllegalArgumentException("str cannot be null.");
        int length = str.length();
        if (length > 0) {
            int index = indexOf(str, 0);
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public KermanCharArray insert(int index, boolean value) {
        validateIndex(index);
        if (value) {
            require(TRUE_STRING_SIZE);
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public KermanCharArray insert(int index, @Nullable char[] ch) {
        validateIndex(index);
     ...
     * @throws IndexOutOfBoundsException if any index is invalid
     */
    public KermanCharArray insert(int index, @Nullable char[] ch, int offset, int length) {
        validateIndex(index);
        if (ch == null) return insert(index, NULL);
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public KermanCharArray insert(int index, double value) {
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public KermanCharArray insert(int index, float value) {
        return insert(index, String.valueOf(value));
    }
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public KermanCharArray insert(int index, int value) {
        return insert(index, String.valueOf(value));
    }
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public KermanCharArray insert(int index, long value) {
        return insert(index, String.valueOf(value));
    }
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public KermanCharArray insert(int index, @Nullable Object obj) {
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public KermanCharArray insert(int index, @Nullable String str) {
        validateIndex(index);
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public KermanCharArray replace(int start, int end, String replaceStr) {
     ...
     */
    public KermanCharArray replaceAll(String searchStr, String replaceStr) {
     ...
     */
    public KermanCharArray replace(char find, String replace) {
     ...
     */
    public KermanCharArray replaceFirst(String searchStr, String replaceStr) {
        int searchLength = searchStr.length();
        if (searchLength > 0) {
            int index = indexOf(searchStr, 0);
            if (index >= 0) {
     ...
     * @throws IndexOutOfBoundsException if any index is invalid
     */
    private void replace(int start, int end, int removeLength, @Nullable String insertStr, int insertLength) {
     ...
     */
    public KermanCharArray reverseCodePoints() {
     ...
     * @see #deleteCharAt(int)
     */
    public KermanCharArray set(CharSequence str) {
        clear();
        append(str);
        return this;
    }
     ...
     * @see #deleteCharAt(int)
     */
    public KermanCharArray setCharAt(int index, char ch) {
        validateIndex(index);
        items[index] = ch;
        return this;
    }
     ...
     */
    public KermanCharArray setLength(int length) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof KermanCharArray)) return false;
        KermanCharArray other = (KermanCharArray) object;
     ...
     * @return true if the CharArrays contain the same characters in the same order
     */
    public boolean equals(KermanCharArray other) {
     ...
     * @return true if the CharArrays contain the same characters in the same order
     */
    public boolean equalsIgnoreCase(KermanCharArray other) {
        if (this == other) return true;
        if (other == null) return false;
        int length = this.size;
        if (length != other.size) return false;
    ...
    class CharArrayReader extends Reader {
        ...
        public int read(char[] b, int off, int length) {
            ...
            KermanCharArray.this.getChars(pos, pos + length, b, off);
            pos += length;
            return length;
        }
    ...
    class CharArrayWriter extends Writer {
        ...
        public void write(char[] cbuf) {
            KermanCharArray.this.append(cbuf);
        }

        public void write(char[] cbuf, int off, int length) {
            KermanCharArray.this.append(cbuf, off, length);
        }

        public void write(int c) {
            KermanCharArray.this.append((char) c);
        }

        public void write(String str) {
            KermanCharArray.this.append(str);
        }

        public void write(String str, int off, int length) {
            KermanCharArray.this.append(str, off, length);
        }
    }
}

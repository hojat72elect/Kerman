...
import com.kerman.core.assets.loaders.BitmapFontLoader;
import com.kerman.core.assets.loaders.CubemapLoader;
import com.kerman.core.assets.loaders.FileHandleResolver;
import com.kerman.core.assets.loaders.I18NBundleLoader;
import com.kerman.core.assets.loaders.MusicLoader;
import com.kerman.core.assets.loaders.ParticleEffectLoader;
import com.kerman.core.assets.loaders.PixmapLoader;
import com.kerman.core.assets.loaders.ShaderProgramLoader;
import com.kerman.core.assets.loaders.SkinLoader;
import com.kerman.core.assets.loaders.SoundLoader;
import com.kerman.core.assets.loaders.TextureAtlasLoader;
...
import com.kerman.core.graphics.k2d.PolygonRegion;
import com.kerman.core.graphics.k2d.PolygonRegionLoader;
import com.kerman.core.graphics.k2d.TextureAtlas;
import com.kerman.core.graphics.k3d.Model;
import com.kerman.core.graphics.k3d.loader.K3dModelLoader;
import com.kerman.core.graphics.k3d.loader.ObjLoader;
...
import com.kerman.core.utils.JsonReader;
import com.kerman.core.utils.Logger;
import com.kerman.core.utils.ObjectIntMap;
import com.kerman.core.utils.ObjectMap;
import com.kerman.core.utils.ObjectMap.Entry;
import com.kerman.core.utils.ObjectSet;
import com.kerman.core.utils.TimeUtils;
import com.kerman.core.utils.UBJsonReader;
import com.kerman.core.utils.async.AsyncExecutor;
import com.kerman.core.utils.async.ThreadUtils;
import com.kerman.core.utils.reflect.ClassReflection;
import org.jetbrains.annotations.Nullable;

/**
 * Info : This class was inspired by "com.badlogic.gdx.assets.AssetManager".
 * <p>
...
public class AssetManager implements Disposable {
    ...
    final ObjectMap<String, KermanArray<String>> assetDependencies = new ObjectMap<>();
    final ObjectSet<String> injected = new ObjectSet<>();

    final ObjectMap<Class, ObjectMap<String, AssetLoader>> loaders = new ObjectMap<>();
    final KermanArray<AssetDescriptor> loadQueue = new KermanArray<>();
    final AsyncExecutor executor;

    final KermanArray<AssetLoadingTask> tasks = new KermanArray<>();
    ...
    public AssetManager(FileHandleResolver resolver, boolean defaultLoaders) {
        ...
        if (defaultLoaders) {
            ...
            setLoader(com.kerman.core.graphics.k3d.particles.ParticleEffect.class,
                    new com.kerman.core.graphics.k3d.particles.ParticleEffectLoader(resolver));
            setLoader(PolygonRegion.class, new PolygonRegionLoader(resolver));
            setLoader(I18NBundle.class, new I18NBundleLoader(resolver));
            setLoader(Model.class, ".g3dj", new K3dModelLoader(new JsonReader(), resolver));
            setLoader(Model.class, ".g3db", new K3dModelLoader(new UBJsonReader(), resolver));
     ...
     * @return the asset
     * @throws KermanRuntimeException if the asset is not loaded
     */
    ...
    /**
     * @param fileName the asset file name
     * @param required true to throw KermanRuntimeException if the asset is not loaded, else null is returned
    ...
    public synchronized @Nullable <T> T get(String fileName, boolean required) {
        ...
        if (required) throw new KermanRuntimeException("Asset not loaded: " + fileName);
        return null;
    }
     ...
     */
    public synchronized <T> KermanArray<T> getAll(Class<T> type, KermanArray<T> out) {
        ObjectMap<String, RefCountedContainer> assetsByType = assets.get(type);
        if (assetsByType != null) {
    ...
    public synchronized void unload(String fileName) {
        ...
        if (type == null) throw new KermanRuntimeException("Asset not loaded: " + fileName);
        ...
        KermanArray<String> dependencies = assetDependencies.get(fileName);
    ...
    public synchronized <T> void load(String fileName, Class<T> type, AssetLoaderParameters<T> parameter) {
        ...
        if (loader == null) throw new KermanRuntimeException("No loader for type: " + ClassReflection.getSimpleName(type));
        ...
        for (int i = 0; i < loadQueue.size; i++) {
            ...
            if (desc.fileName.equals(fileName) && !desc.type.equals(type)) throw new KermanRuntimeException(
        ...
        if (otherType != null && !otherType.equals(type))
            throw new KermanRuntimeException("Asset with name '" + fileName + "' already loaded, but has different type (expected: "
    ...
    public boolean update(int millis) {
        if (Kerman.app.getType() == Application.ApplicationType.WebGL) return update();
    ...
    synchronized void injectDependencies(String parentAssetFilename, KermanArray<AssetDescriptor> dependendAssetDescs) {
    ...
    private synchronized void injectDependency(String parentAssetFilename, AssetDescriptor dependendAssetDesc) {
        ...
        KermanArray<String> dependencies = assetDependencies.get(parentAssetFilename);
        if (dependencies == null) {
            dependencies = new KermanArray<>();
    ...
    private void addTask(AssetDescriptor assetDesc) {
        ...
        if (loader == null) throw new KermanRuntimeException("No loader for type: " + ClassReflection.getSimpleName(assetDesc.type));
    ...
    private void incrementRefCountedDependencies(String parent) {
        KermanArray<String> dependencies = assetDependencies.get(parent);
    ...
    private void handleTaskError(Throwable t) {
        ...
        if (tasks.isEmpty()) throw new KermanRuntimeException(t);
        ...
        if (listener != null)
            ...
            throw new KermanRuntimeException(t);
    }
    ...
    public void clear() {
        ...
        synchronized (this) {
            ...
            while (assetTypes.size > 0) {
                ...
                KermanArray<String> assets = assetTypes.keys().toArray();
                for (String asset : assets) {
                    KermanArray<String> dependencies = assetDependencies.get(asset);
     ...
     */
    public synchronized KermanArray<String> getAssetNames() {
     ...
     */
    public synchronized KermanArray<String> getDependencies(String fileName) {

...
/**
 * Info : This class was inspired by the "com.badlogic.gdx.assets.loaders.ShaderProgramLoader".
 * <p>
...
public class ShaderProgramLoader extends AsynchronousAssetLoader<ShaderProgram, ShaderProgramLoader.ShaderProgramParameter> {
    ...
    @Override
    public KermanArray<AssetDescriptor> getDependencies(String fileName, FileHandle file, ShaderProgramParameter parameter) {
        return null;
    }

...
/**
 * Info : This abstract class was inspired by "com.badlogic.gdx.assets.loaders.AsynchronousAssetLoader".
 * <p>
 * Base class for asynchronous {@link AssetLoader} instances. Such loaders try to load parts of an OpenGL resource, like the
 * Pixmap, on a separate thread, then load the actual resource on the thread the OpenGL context is active on.
 *
 * @param <T>
 * @param <P>
 */

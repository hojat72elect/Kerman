...
/**
 * Info : This class was inspired by "com.badlogic.gdx.assets.loaders.resolvers.ResolutionFileResolver".
 * <p>
...
public class ResolutionFileResolver implements FileHandleResolver {
    ...
    static public Resolution choose(Resolution... descriptors) {
        int w = Kerman.graphics.getBackBufferWidth(), h = Kerman.graphics.getBackBufferHeight();

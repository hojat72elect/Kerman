...
/**
 * This abstract class was inspired by "com.badlogic.gdx.assets.loaders.ModelLoader".
 */
public abstract class ModelLoader<P extends ModelLoader.ModelParameters> extends AsynchronousAssetLoader<Model, P> {
    protected KermanArray<ObjectMap.Entry<String, ModelData>> items = new KermanArray<>();
    ...
    @Override
    public KermanArray<AssetDescriptor> getDependencies(String fileName, FileHandle file, P parameters) {
        final KermanArray<AssetDescriptor> deps = new KermanArray<>();

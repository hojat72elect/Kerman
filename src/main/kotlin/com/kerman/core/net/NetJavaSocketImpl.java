...
import com.kerman.core.Net.Protocol;
...
public class NetJavaSocketImpl implements Socket {
    ...
    public NetJavaSocketImpl(Protocol protocol, String host, int port, SocketHints hints) {
        try {
            ...
            throw new KermanRuntimeException("Error making a socket connection to " + host + ":" + port, e);
        }
    }
    ...
    private void applyHints(SocketHints hints) {
        if (hints != null) {
            try {
                ...
                throw new KermanRuntimeException("Error setting socket hints.", e);
            }
        }
    }
    ...
    public InputStream getInputStream() {
        try {
            ...
            throw new KermanRuntimeException("Error getting input stream from socket.", e);
        }
    }
    ...
    public OutputStream getOutputStream() {
        try {
            ...
            throw new KermanRuntimeException("Error getting output stream from socket.", e);
        }
    }
    ...
    public void dispose() {
        if (socket != null) {
            try {
                ...
                throw new KermanRuntimeException("Error closing socket.", e);
            }
        }
    }
}

...
import com.kerman.core.Net.HttpMethods;
import com.kerman.core.Net.HttpRequest;
import com.kerman.core.Net.HttpResponse;
import com.kerman.core.Net.HttpResponseListener;
...
public class NetJavaImpl {
    ...
    public void sendHttpRequest(final HttpRequest httpRequest, final HttpResponseListener httpResponseListener) {
        if (httpRequest.getUrl() == null) {
            httpResponseListener.failed(new KermanRuntimeException("can't process a HTTP request without URL set"));
            return;
        }

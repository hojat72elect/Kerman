...
/**
 * Info : This class was inspired by "com.badlogic.gdx.scenes.scene2d.utils.ArraySelection".
 * <p>
...
public class ArraySelection<T> extends Selection<T> {
    ...
    public ArraySelection(KermanArray<T> array) {
        this.array = array;
    }
    ...
    public void validate() {
        KermanArray<T> array = this.array;
        if (array.size == 0) {
            clear();
            return;
        }

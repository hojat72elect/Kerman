...
import com.kerman.core.graphics.k2d.BitmapFontCache;
...
import com.kerman.core.utils.KermanCharArray;
import org.jetbrains.annotations.Nullable;

/**
 * Info : this class was inspired by "com.badlogic.gdx.scenes.scene2d.ui.Label".
 * <p>
...
public class Label extends Widget implements Styleable<Label.LabelStyle> {
    ...
    private final KermanCharArray text = new KermanCharArray();
    ...
    public KermanCharArray getText() {
        return text;
    }
    ...
    public void setText(@Nullable CharSequence newText) {
        if (newText == null) {
            ...
            text.clear();
        } else if (newText instanceof KermanCharArray) {
            if (text.equals(newText)) return;
            text.clear();
            text.append((KermanCharArray) newText);
        } else {

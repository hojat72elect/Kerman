...
import com.kerman.core.scenes.scene2d.ui.Value.Fixed;
...
/**
 * Info : This class was inspired by "com.badlogic.gdx.scenes.scene2d.ui.Table".
 * <p>
...
public class Table extends WidgetGroup {
    ...
    private final KermanArray<Cell> cells = new KermanArray<>(4);
    private final Cell cellDefaults;
    private final KermanArray<Cell> columnDefaults = new KermanArray<>(2);
    Value padTop = backgroundTop, padLeft = backgroundLeft, padBottom = backgroundBottom, padRight = backgroundRight;
    int align = Align.center;
    Debug debug = Debug.none;
    KermanArray<DebugRect> debugRects;
    @Nullable
    Drawable background;
    boolean round = true;
     ...
     */
    public KermanArray<Cell> getCells() {
        return cells;
    }
    ...
    public void layout() {
        ...
        KermanArray<Actor> childrenArray = getChildren();
    ...
    private void clearDebugRects() {
        if (debugRects == null) debugRects = new KermanArray<>();

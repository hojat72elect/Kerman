...
/**
 * Info : This class was inspired by "com.badlogic.gdx.scenes.scene2d.ui.ButtonGroup".
 * <p>
...
public class ButtonGroup<T extends Button> {
    private final KermanArray<T> buttons = new KermanArray<>();
    private final KermanArray<T> checkedButtons = new KermanArray<>(1);
    ...
    public KermanArray<T> getAllChecked() {
        return checkedButtons;
    }

    public KermanArray<T> getButtons() {
        return buttons;
    }

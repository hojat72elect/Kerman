...
/**
 * Info : This class was inspired by "com.badlogic.gdx.scenes.scene2d.ui.Slider".
 * <p>
...
public class Slider extends ProgressBar {
    ...
    boolean calculatePositionAndValue(float x, float y) {
        ...
        if (!Kerman.input.isKeyPressed(Keys.SHIFT_LEFT) && !Kerman.input.isKeyPressed(Keys.SHIFT_RIGHT)) value = snap(value);

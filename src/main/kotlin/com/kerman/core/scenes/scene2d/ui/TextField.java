...
/**
 * Info : This class was inspired by "com.badlogic.gdx.scenes.scene2d.ui.TextField".
 * <p>
...
public class TextField extends Widget implements Disableable, Styleable<TextField.TextFieldStyle> {
    ...
    protected final KermanFloatArray glyphPositions = new KermanFloatArray();
    ...
    public TextField(@Nullable String text, TextFieldStyle style) {
        setStyle(style);
        clipboard = Kerman.app.getClipboard();
        initialize();
        setText(text);
    ...
    public void next(boolean up) {
        ...
        while (true) {
            ...
            if (textField == null) {
                Kerman.input.setOnscreenKeyboardVisible(false);
                break;
            }
     ...
     * @return May be null.
     */
    private @Nullable TextField findNextTextField(KermanArray<Actor> actors, @Nullable TextField best, Vector2 bestCoords,
    ...
    static public class DefaultOnscreenKeyboard implements OnscreenKeyboard {
        public void show(boolean visible) {
            Kerman.input.setOnscreenKeyboardVisible(visible);
        }
    }
    ...
    public class TextFieldClickListener extends ClickListener {
        ...
        public boolean keyTyped(InputEvent event, char character) {
            ...
            if (UIUtils.isMac && Kerman.input.isKeyPressed(Keys.SYM)) return true;

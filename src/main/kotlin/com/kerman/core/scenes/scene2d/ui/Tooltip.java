...
import com.kerman.core.scenes.scene2d.*;
import org.jetbrains.annotations.Nullable;


/**
 * Info : This class was inspired by "com.badlogic.gdx.scenes.scene2d.ui.Tooltip".
 * <p>
...
public class Tooltip<T extends Actor> extends InputListener {
    ...
    public void enter(InputEvent event, float x, float y, int pointer, @Nullable Actor fromActor) {
        if (pointer != -1) return;
        if (touchIndependent && Kerman.input.isTouched()) return;

...
import com.kerman.core.graphics.k2d.BitmapFont.BitmapFontData;
import com.kerman.core.graphics.k2d.NinePatch;
...
import com.kerman.core.scenes.scene2d.utils.BaseDrawable;
import com.kerman.core.scenes.scene2d.utils.Drawable;
import com.kerman.core.scenes.scene2d.utils.NinePatchDrawable;
import com.kerman.core.scenes.scene2d.utils.SpriteDrawable;
import com.kerman.core.scenes.scene2d.utils.TextureRegionDrawable;
import com.kerman.core.scenes.scene2d.utils.TiledDrawable;
...
import com.kerman.core.utils.Json.ReadOnlySerializer;
...
import com.kerman.core.utils.reflect.Method;
import com.kerman.core.utils.reflect.ReflectionException;
import org.jetbrains.annotations.Nullable;

/**
 * Info : This class was inspired by "com.badlogic.gdx.scenes.scene2d.ui.Skin".
 * <p>
...
public class Skin implements Disposable {
    ...
    public void addRegions(TextureAtlas atlas) {
        KermanArray<AtlasRegion> regions = atlas.getRegions();
     ...
     *
     * @throws KermanRuntimeException if the resource was not found.
     */
    ...
    public <T> T get(String name, Class<T> type) {
        ...
        ObjectMap<String, Object> typeResources = resources.get(type);
        if (typeResources == null) throw new KermanRuntimeException("No " + type.getName() + " registered with name: " + name);
        Object resource = typeResources.get(name);
        if (resource == null) throw new KermanRuntimeException("No " + type.getName() + " registered with name: " + name);
        return (T) resource;
    }
    ...
    public TextureRegion getRegion(String name) {
        ...
        if (texture == null) throw new KermanRuntimeException("No TextureRegion or Texture registered with name: " + name);
     ...
     */
    public @Nullable KermanArray<TextureRegion> getRegions(String regionName) {
        KermanArray<TextureRegion> regions = null;
        int i = 0;
        TextureRegion region = optional(regionName + "_" + (i++), TextureRegion.class);
        if (region != null) {
            regions = new KermanArray<>();
            while (region != null) {
                regions.add(region);
    ...
    public NinePatch getPatch(String name) {
        ...
        try {
            ...
            return patch;
        } catch (KermanRuntimeException ex) {
            throw new KermanRuntimeException("No NinePatch, TextureRegion, or Texture registered with name: " + name);
        }
    }
    ...
    public Drawable getDrawable(String name) {
        ...
        } catch (KermanRuntimeException ignored) {
        }
    ...
    public Drawable newDrawable(Drawable drawable) {
        ...
        throw new KermanRuntimeException("Unable to copy, unknown drawable type: " + drawable.getClass());
    }
    ...
    protected Json getJsonLoader(final FileHandle skinFile) {
                ...
                if (jsonMap.has(parentFieldName)) {
                    ...
                    while (true) {
                        try {
                            ...
                            break;
                        } catch (KermanRuntimeException ex) { // Parent resource doesn't exist.
        ...
        json.setSerializer(BitmapFont.class, new ReadOnlySerializer<BitmapFont>() {
            public BitmapFont read(Json json, JsonValue jsonData, Class type) {
                ...
                if (!fontFile.exists()) fontFile = Kerman.files.internal(path);
                ...
                try {
                    BitmapFont font;
                    KermanArray<TextureRegion> regions = skin.getRegions(regionName);
                    if (regions != null)

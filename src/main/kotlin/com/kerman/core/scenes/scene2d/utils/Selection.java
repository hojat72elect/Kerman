...
import com.kerman.core.utils.OrderedSet;
...
/**
 * Info : This class was inspired by "com.badlogic.gdx.scenes.scene2d.utils.Selection".
 * <p>
...
public class Selection<T> implements Disableable, Iterable<T> {
    ...
    public void setAll(KermanArray<T> items) {
        boolean added = false;
        snapshot();
        lastSelected = null;
    ...
    public void addAll(KermanArray<T> items) {
        boolean added = false;
        snapshot();
        for (int i = 0, n = items.size; i < n; i++) {
            T item = items.get(i);
    ...
    public void removeAll(KermanArray<T> items) {
    ...
    public KermanArray<T> toArray() {
        return selected.iterator().toArray();
    }

    public KermanArray<T> toArray(KermanArray<T> array) {

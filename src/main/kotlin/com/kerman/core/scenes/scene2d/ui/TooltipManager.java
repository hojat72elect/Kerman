...
import static com.kerman.core.math.Interpolation.fade;
import static com.kerman.core.scenes.scene2d.actions.Actions.*;

/**
 * Info : This class was inspired by "com.badlogic.gdx.scenes.scene2d.ui.TooltipManager".
 * <p>
...
public class TooltipManager {
    ...
    final KermanArray<Tooltip> shown = new KermanArray<>();
    /**
    ...
    static public TooltipManager getInstance() {
        if (files == null || files != Kerman.files) {
            files = Kerman.files;

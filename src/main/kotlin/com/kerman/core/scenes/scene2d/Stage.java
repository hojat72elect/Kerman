...
import com.kerman.core.graphics.glutils.ShapeRenderer;
import com.kerman.core.math.Matrix4;
import com.kerman.core.math.Rectangle;
import com.kerman.core.math.Vector2;
import com.kerman.core.scenes.scene2d.InputEvent.Type;
import com.kerman.core.scenes.scene2d.ui.Table;
import com.kerman.core.scenes.scene2d.ui.Table.Debug;
import com.kerman.core.scenes.scene2d.utils.FocusListener;
import com.kerman.core.scenes.scene2d.utils.FocusListener.FocusEvent;
import com.kerman.core.scenes.scene2d.utils.ScissorStack;
import com.kerman.core.utils.KermanArray;
import com.kerman.core.utils.Disposable;
import com.kerman.core.utils.Pool.Poolable;
import com.kerman.core.utils.PoolManager;
import com.kerman.core.utils.Scaling;
import com.kerman.core.utils.SnapshotArray;
import com.kerman.core.utils.viewport.ScalingViewport;
import com.kerman.core.utils.viewport.Viewport;

import org.jetbrains.annotations.Nullable;

/**
 * Info : This class was inspired by "com.badlogic.gdx.scenes.scene2d.Stage".
 * <p>
 ...
 * {@link Input#setInputProcessor(com.kerman.core.InputProcessor) Gdx.input.setInputProcessor}. An {@link InputMultiplexer} may
...
public class Stage extends InputAdapter implements Disposable {
     ...
     */
    public Stage() {
        this(new ScalingViewport(Scaling.stretch, Kerman.graphics.getWidth(), Kerman.graphics.getHeight(), new OrthographicCamera()),
                new SpriteBatch());
        ownsBatch = true;
    }
    ...
    public Stage(Viewport viewport, Batch batch) {
        ...
        viewport.update(Kerman.graphics.getWidth(), Kerman.graphics.getHeight(), true);
    }
    ...
    private void drawDebug() {
        ...
        if (debugUnderMouse || debugParentUnderMouse || debugTableUnderMouse != Debug.none) {
            screenToStageCoordinates(tempCoords.set(Kerman.input.getX(), Kerman.input.getY()));
     ...
     */
    public void act() {
        act(Math.min(Kerman.graphics.getDeltaTime(), 1 / 30f));
    }
    ...
    public void act(float delta) {
        ...
        ApplicationType type = Kerman.app.getType();
     ...
     */
    public KermanArray<Actor> getActors() {
    ...
    public Vector2 stageToScreenCoordinates(Vector2 stageCoords) {
        ...
        stageCoords.y = Kerman.graphics.getHeight() - stageCoords.y;
        return stageCoords;
    }
    ...
    protected boolean isInsideViewport(int screenX, int screenY) {
        ...
        screenY = Kerman.graphics.getHeight() - 1 - screenY;

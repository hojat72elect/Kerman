...
import com.kerman.core.scenes.scene2d.utils.Cullable;
...
/**
 * Info : This class was inspired by "com.badlogic.gdx.scenes.scene2d.ui.List".
 * <p>
...
public class List<T> extends Widget implements Cullable, Styleable<List.ListStyle> {
     ...
     * from {@link #getItems()}.
     */
    public void setItems(KermanArray newItems) {
        if (newItems == null) throw new IllegalArgumentException("newItems cannot be null.");
        float oldPrefWidth = getPrefWidth(), oldPrefHeight = getPrefHeight();

...
import static com.kerman.core.scenes.scene2d.actions.Actions.fadeIn;
import static com.kerman.core.scenes.scene2d.actions.Actions.fadeOut;
import static com.kerman.core.scenes.scene2d.actions.Actions.removeActor;
import static com.kerman.core.scenes.scene2d.actions.Actions.sequence;
...
import com.kerman.core.math.Interpolation;
...
import com.kerman.core.scenes.scene2d.ui.List.ListStyle;
import com.kerman.core.scenes.scene2d.ui.ScrollPane.ScrollPaneStyle;
import com.kerman.core.scenes.scene2d.utils.ArraySelection;
...
import com.kerman.core.scenes.scene2d.utils.Disableable;
...
/**
 * Info : This class was inspired by "com.badlogic.gdx.scenes.scene2d.ui.SelectBox".
 * <p>
...
public class SelectBox<T> extends Widget implements Disableable, Styleable<SelectBox.SelectBoxStyle> {
    ...
    final KermanArray<T> items = new KermanArray<>();
    ...
    /**
     * Returns the internal items array. If modified, {@link #setItems(KermanArray)} must be called to reflect the changes.
     */
    public KermanArray<T> getItems() {
        return items;
    }
     ...
     */
    public void setItems(KermanArray<T> newItems) {
        if (newItems == null) throw new IllegalArgumentException("newItems cannot be null.");
        float oldPrefWidth = getPrefWidth();

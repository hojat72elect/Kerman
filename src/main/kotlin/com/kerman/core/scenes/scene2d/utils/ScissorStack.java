...
import com.kerman.core.graphics.glutils.HdpiUtils;
...
/**
 * Info : This class was inspired by "com.badlogic.gdx.scenes.scene2d.utils.ScissorStack".
 * <p>
 * A stack of {@link Rectangle} objects to be used for clipping via {@link GLES20#glScissor(int, int, int, int)}. When a new
...
public class ScissorStack {
    ...
    private static final KermanArray<Rectangle> scissors = new KermanArray<Rectangle>();
     ...
     * {@link GLES20#glScissor(int, int, int, int)} with the final top of stack rectangle. In case no scissor is yet on the stack
     * this will also enable {@link GLES20#GL_SCISSOR_TEST} automatically.
     * <p>
     ...
     * no more rectangles are on the stack, {@link GLES20#GL_SCISSOR_TEST} is disabled.
     * <p>
    ...
    public static void calculateScissors(Camera camera, Matrix4 batchTransform, Rectangle area, Rectangle scissor) {
        calculateScissors(camera, 0, 0, Kerman.graphics.getWidth(), Kerman.graphics.getHeight(), batchTransform, area, scissor);
    }
     ...
     * {@link GLES20#glScissor(int, int, int, int)}.
     *
    ...
    public static Rectangle getViewport() {
        if (scissors.size == 0) {
            viewport.set(0, 0, Kerman.graphics.getWidth(), Kerman.graphics.getHeight());
            return viewport;
        } else {
            Rectangle scissor = scissors.peek();

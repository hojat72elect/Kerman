...
/**
 * Info : This class was inspired by "com.badlogic.gdx.scenes.scene2d.Group".
 * <p>
...
public class Group extends Actor implements Cullable {
     ...
     * {@link Action#setPool(com.kerman.core.utils.Pool) pool}, if any. This is not done automatically.
     *
    ...
    public @Nullable <T extends Actor> T findActor(String name) {
        KermanArray<Actor> children = this.children;
        for (int i = 0, n = children.size; i < n; i++)

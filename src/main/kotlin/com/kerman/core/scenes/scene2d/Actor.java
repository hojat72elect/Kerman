...
import static com.kerman.core.utils.Align.bottom;
import static com.kerman.core.utils.Align.left;
import static com.kerman.core.utils.Align.right;
import static com.kerman.core.utils.Align.top;
import com.kerman.core.Kerman;
import com.kerman.core.graphics.Color;
import com.kerman.core.graphics.glutils.ShapeRenderer;
import com.kerman.core.graphics.glutils.ShapeRenderer.ShapeType;
import com.kerman.core.graphics.k2d.Batch;
import com.kerman.core.graphics.k2d.GlyphLayout;
import com.kerman.core.math.MathUtils;
import com.kerman.core.math.Rectangle;
import com.kerman.core.math.Vector2;
import com.kerman.core.scenes.scene2d.utils.ActorGestureListener;
...
import com.kerman.core.utils.DelayedRemovalArray;
...
/**
 * Info : this class was inspired by "com.badlogic.gdx.scenes.scene2d.Actor".
 * <p>
...
public class Actor {
    ...
    private final KermanArray<Action> actions = new KermanArray<>(0);
    @Nullable
    Group parent;
    float x, y;
    float width, height;
     ...
     * {@link Batch#draw(com.kerman.core.graphics.k2d.TextureRegion, float, float, float, float, float, float, float, float, float)
    ...
    public void act(float delta) {
        ...
        if (stage != null && stage.getActionsRequestRendering()) Kerman.graphics.requestRendering();
        try {
    ...
    public boolean fire(Event event) {
        ...
        KermanArray<Group> ascendants = POOLS.obtain(KermanArray.class);
    ...
    public boolean setZIndex(int index) {
        ...
        KermanArray<Actor> children = parent.children;

...
/**
 * Info : This abstract class was inspired by "com.badlogic.gdx.Game".
 * <p>
...
public abstract class Game implements ApplicationListener {
    ...
    @Override
    public void render() {
        if (screen != null) screen.render(Kerman.graphics.getDeltaTime());
    }
    ...
    public void setScreen(Screen screen) {
        ...
        if (this.screen != null) {
            this.screen.show();
            this.screen.resize(Kerman.graphics.getWidth(), Kerman.graphics.getHeight());
        }
    }
}

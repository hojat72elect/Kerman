 ...
 * <p>
 * Info : This class was inspired by "com.badlogic.gdx.files.FileHandle".
 */
public class FileHandle {
    ...
    static public FileHandle tempFile(String prefix) {
        try {
            ...
            throw new KermanRuntimeException("Unable to create temp file.", ex);
        }
    }
    ...
    static private void copyFile(FileHandle source, FileHandle dest) {
        try {
            ...
            throw new KermanRuntimeException("Error copying source file: " + source.file + " (" + source.type + ")\n" //
     ...
     */
    public File file() {
        if (type == FileType.External) return new File(Kerman.files.getExternalStoragePath(), file.getPath());
        return file;
    }
     ...
     *
     * @throws KermanRuntimeException if the file handle represents a directory, doesn't exist, or could not be read.
     */
    public InputStream read() {
        if (type == FileType.Classpath || (type == FileType.Internal && !file().exists())
            ...
            if (input == null) throw new KermanRuntimeException("File not found: " + file + " (" + type + ")");
            return input;
        }
        try {
            ...
            if (file().isDirectory())
                throw new KermanRuntimeException("Cannot open a stream to a directory: " + file + " (" + type + ")", ex);
            throw new KermanRuntimeException("Error reading file: " + file + " (" + type + ")", ex);
        }
    }
    ...
    public Reader reader(String charset) {
        ...
        try {
            ...
            throw new KermanRuntimeException("Error reading file: " + this, ex);
        }
    }
    ...
    public String readString(String charset) {
        ...
        try {
            ...
            throw new KermanRuntimeException("Error reading layout file: " + this, ex);
        } finally {
     ...
     *
     * @throws KermanRuntimeException if this file handle represents a directory, doesn't exist, or could not be read, or memory
    ...
    public ByteBuffer map(MapMode mode) {
        if (type == FileType.Classpath) throw new KermanRuntimeException("Cannot map a classpath file: " + this);
        ...
        try {
            ...
            throw new KermanRuntimeException("Error memory mapping file: " + this + " (" + type + ")", ex);
        } finally {
     ...
     * @throws KermanRuntimeException if this file handle represents a directory, if it is a {@link FileType#Classpath} or
     *                             {@link FileType#Internal} file, or if it could not be written.
     */
    public OutputStream write(boolean append) {
        if (type == FileType.Classpath) throw new KermanRuntimeException("Cannot write to a classpath file: " + file);
        if (type == FileType.Internal) throw new KermanRuntimeException("Cannot write to an internal file: " + file);
        parent().mkdirs();
        try {
            ...
            if (file().isDirectory())
                throw new KermanRuntimeException("Cannot open a stream to a directory: " + file + " (" + type + ")", ex);
            throw new KermanRuntimeException("Error writing file: " + file + " (" + type + ")", ex);
        }
    }
    ...
    public void write(InputStream input, boolean append) {
        ...
        try {
            ...
            throw new KermanRuntimeException("Error stream writing to file: " + file + " (" + type + ")", ex);
        } finally {
            StreamUtils.closeQuietly(input);
     ...
     * array.
     *
     * @throws KermanRuntimeException if this file is an {@link FileType#Classpath} file.
     */
    public FileHandle[] list() {
        if (type == FileType.Classpath) throw new KermanRuntimeException("Cannot list a classpath directory: " + file);
     ...
     *
     * @throws KermanRuntimeException if this file is the root.
     */
    public FileHandle sibling(String name) {
        if (file.getPath().length() == 0) throw new KermanRuntimeException("Cannot get the sibling of the root.");
    ...
    /**
     * @throws KermanRuntimeException if this file handle is a {@link FileType#Classpath} or {@link FileType#Internal} file.
     */
    public void mkdirs() {
        if (type == FileType.Classpath) throw new KermanRuntimeException("Cannot mkdirs with a classpath file: " + file);
        if (type == FileType.Internal) throw new KermanRuntimeException("Cannot mkdirs with an internal file: " + file);
        file().mkdirs();
    }
    ...
    public boolean delete() {
        if (type == FileType.Classpath) throw new KermanRuntimeException("Cannot delete a classpath file: " + file);
        if (type == FileType.Internal) throw new KermanRuntimeException("Cannot delete an internal file: " + file);
        return file().delete();
    }
     ...
     * this handle is a directory, then 1) if the destination is a file, KermanRuntimeException is thrown, or 2) if the destination is
     * a directory, this directory is copied into it recursively, overwriting existing files, or 3) if the destination doesn't
     * exist, {@link #mkdirs()} is called on the destination and this directory is copied into it recursively.
     *
     * @throws KermanRuntimeException if the destination file handle is a {@link FileType#Classpath} or {@link FileType#Internal}
    ...
    public void copyTo(FileHandle dest) {
        ...
        if (dest.exists()) {
            if (!dest.isDirectory()) throw new KermanRuntimeException("Destination exists but is not a directory: " + dest);
        } else {
            dest.mkdirs();
            if (!dest.isDirectory()) throw new KermanRuntimeException("Destination directory cannot be created: " + dest);
        }
     ...
     *
     * @throws KermanRuntimeException if the source or destination file handle is a {@link FileType#Classpath} or
     *                             {@link FileType#Internal} file.
     */
    public void moveTo(FileHandle dest) {
        switch (type) {
            case Classpath:
                throw new KermanRuntimeException("Cannot move a classpath file: " + file);
            case Internal:
                throw new KermanRuntimeException("Cannot move an internal file: " + file);
            case Absolute:
            case External:

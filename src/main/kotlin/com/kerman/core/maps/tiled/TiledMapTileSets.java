...
/**
 * Info : This class was inspired by "com.badlogic.gdx.maps.tiled.TiledMapTileSets".
 * <p>
 * Collection of {@link TiledMapTileSet}
 */
public class TiledMapTileSets implements Iterable<TiledMapTileSet> {

    private final KermanArray<TiledMapTileSet> tilesets;

    /**
     * Creates an empty collection of tilesets.
     */
    public TiledMapTileSets() {
        tilesets = new KermanArray<TiledMapTileSet>();
    }

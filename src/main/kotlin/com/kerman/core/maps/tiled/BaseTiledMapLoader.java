...
/**
 * Info : This abstract class was inspired by "com.badlogic.gdx.maps.tiled.BaseTiledMapLoader".
 */
public abstract class BaseTiledMapLoader<P extends BaseTiledMapLoader.Parameters> extends AsynchronousAssetLoader<TiledMap, P> {
    ...
    protected KermanArray<Runnable> runOnEndOfLoadTiled;
    /**
     * Optional Tiled project class information. Key is the classname and value is an array of class members (=class
     * properties)
     */
    protected ObjectMap<String, KermanArray<ProjectClassMember>> projectClassInfo;
     ...
     */
    protected abstract KermanArray<AssetDescriptor> getDependencyAssetDescriptors(FileHandle mapFile,
    ...
    protected Object castProperty(String name, String value, String type) {
        if (type == null || "string".equals(type) || "file".equals(type)) {
            ...
            throw new KermanRuntimeException("Wrong type given for property " + name + ", given : " + type
    ...
    protected void loadObjectProperty(final MapProperties properties, final String name, String value) {
        ...
        try {
            ...
            throw new KermanRuntimeException("Error parsing property [\" + name + \"] of type \"object\" with value: [" + value + "]",
                    exception);
        }
    }
    ...
    protected void loadProjectFile(String projectFilePath) {
        ...
        for (JsonValue propertyType : propertyTypes) {
            ...
            KermanArray<ProjectClassMember> projectClassMembers = new KermanArray<>();
    ...
    protected void loadMapPropertiesClassDefaults(String className, MapProperties mapProperties) {
        if (projectClassInfo == null) {
            Kerman.app.log("TiledMapLoader", "WARN: There is at least one property of type class or an object with a class defined. "
        ...
        KermanArray<ProjectClassMember> classMembers = projectClassInfo.get(className);

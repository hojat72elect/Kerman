...
/**
 * Info : This abstract class was inspired by "com.badlogic.gdx.maps.tiled.BaseTmjMapLoader".
 */
public abstract class BaseTmjMapLoader<P extends BaseTiledMapLoader.Parameters> extends BaseTiledMapLoader<P> {
        ...
        if (encoding == null || encoding.isEmpty() || encoding.equals("csv")) {
            ...
            try {
                ...
                if (compression == null || compression.isEmpty())
                    ...
                    throw new KermanRuntimeException("Unrecognised compression (" + compression + ") for TMJ Layer Data");
                ...
                for (int y = 0; y < height; y++) {
                    for (int x = 0; x < width; x++) {
                        ...
                        if (read != temp.length)
                            throw new KermanRuntimeException("Error Reading TMJ Layer Data: Premature end of tile data");
                        ids[y * width + x] = unsignedByteToInt(temp[0]) | unsignedByteToInt(temp[1]) << 8
                                | unsignedByteToInt(temp[2]) << 16 | unsignedByteToInt(temp[3]) << 24;
                    }
                }
            } catch (IOException e) {
                throw new KermanRuntimeException("Error Reading TMJ Layer Data - IOException: " + e.getMessage());
            } finally {
            ...
            // or another editor
            throw new KermanRuntimeException("Unrecognised encoding (" + encoding + ") for TMJ Layer Data");
        }
    ...
    @Override
    public KermanArray<AssetDescriptor> getDependencies(String fileName, FileHandle tmjFile, P parameter) {
    ...
    protected JsonValue resolveTemplateObject(TiledMap map, MapLayer layer, JsonValue mapElement, FileHandle tmjFile) {
        ...
        if (templateElement == null) {
            ...
            try {
                ...
                throw new KermanRuntimeException("Error parsing template file: " + tjFileName, e);
            }
    ...
    protected AnimatedTiledMapTile createAnimatedTile(TiledMapTileSet tileSet, TiledMapTile tile, JsonValue tileElement,
        ...
        if (animationElement != null) {
            KermanArray<StaticTiledMapTile> staticTiles = new KermanArray<>();

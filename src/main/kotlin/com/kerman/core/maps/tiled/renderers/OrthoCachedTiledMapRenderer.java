package com.kerman.core.maps.tiled.renderers;
...
import com.kerman.core.graphics.k2d.SpriteCache;
...
import com.kerman.core.maps.tiled.TiledMapImageLayer;
import com.kerman.core.maps.tiled.TiledMapRenderer;
...
import static com.kerman.core.graphics.k2d.Batch.*;

/**
 * Info : This class was inspired by "com.badlogic.gdx.maps.tiled.renderers.OrthoCachedTiledMapRenderer".
 * <p>
 * Renders orthogonal tiles by caching geometry on the GPU. How much is cached is controlled by {@link #setOverCache(float)}. When the
...
public class OrthoCachedTiledMapRenderer implements TiledMapRenderer, Disposable {
    ...
    public void render() {
        ...
        if (blending) {
            ...
            Kerman.gl.glBlendFunc(GLES20.GL_SRC_ALPHA, GLES20.GL_ONE_MINUS_SRC_ALPHA);
        }
        spriteCache.begin();

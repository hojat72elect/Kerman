...
import com.kerman.core.graphics.Mesh.VertexDataType;
...
import com.kerman.core.math.Affine2;
...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g2d.SpriteBatch".
 * <p>
...
public class SpriteBatch implements Batch {
    ...
    public SpriteBatch(int size, ShaderProgram defaultShader) {
        ...
        VertexDataType vertexDataType = (Kerman.gl30 != null) ? VertexDataType.VertexBufferObjectWithVAO : defaultVertexDataType;
    ...
    public void end() {
        ...
        GLES20 gl = Kerman.gl;
        gl.glDepthMask(true);
        if (isBlendingEnabled()) gl.glDisable(GLES20.GL_BLEND);
    }
    ...
    public void flush() {
        ...
        if (blendingDisabled) {
            ...
            if (blendSrcFunc != -1) Kerman.gl.glBlendFuncSeparate(blendSrcFunc, blendDstFunc, blendSrcFuncAlpha, blendDstFuncAlpha);
        }

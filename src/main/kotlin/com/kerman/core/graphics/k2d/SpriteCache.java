...
import static com.kerman.core.graphics.k2d.Sprite.SPRITE_SIZE;
import static com.kerman.core.graphics.k2d.Sprite.VERTEX_SIZE;

/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g2d.SpriteCache".
 *
...
public class SpriteCache implements Disposable {
    ...
    private final KermanArray<Texture> textures = new KermanArray<>(8);
    private final KermanIntArray counts = new KermanIntArray(8);
    ...
    private final KermanArray<Cache> caches = new KermanArray<>();
    ...
    public SpriteCache(int size, ShaderProgram shader, boolean useIndices) {
        ...
        projectionMatrix.setToOrtho2D(0, 0, Kerman.graphics.getWidth(), Kerman.graphics.getHeight());
    }
    ...
    public void draw(int cacheID) {
        ...
        for (int i = 0; i < textureCount; i++) {
            ...
            textures[i].bind();
            if (customShader != null)
                mesh.render(customShader, GLES20.GL_TRIANGLES, offset, count);
            else
                mesh.render(shader, GLES20.GL_TRIANGLES, offset, count);
            offset += count;
        }

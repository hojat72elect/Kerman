...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g2d.ParticleEffectPool".
 */
public class ParticleEffectPool extends Pool<ParticleEffectPool.PooledEffect> {
    ...
    public void free(PooledEffect effect) {
        ...
        if (effect.xSizeScale != this.effect.xSizeScale || effect.ySizeScale != this.effect.ySizeScale
            ...
            KermanArray<ParticleEmitter> emitters = effect.getEmitters();
            KermanArray<ParticleEmitter> templateEmitters = this.effect.getEmitters();

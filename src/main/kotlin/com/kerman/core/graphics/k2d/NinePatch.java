...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g2d.NinePatch".
 * <p>
...
public class NinePatch {
    ...
    public NinePatch(TextureRegion... patches) {
        ...
        if ((patches[TOP_LEFT] != null && patches[TOP_LEFT].getRegionWidth() != leftWidth)
            ...
            throw new KermanRuntimeException("Left side patches must have the same width");
        }
        if ((patches[TOP_RIGHT] != null && patches[TOP_RIGHT].getRegionWidth() != rightWidth)
            ...
            throw new KermanRuntimeException("Right side patches must have the same width");
        }
        if ((patches[BOTTOM_LEFT] != null && patches[BOTTOM_LEFT].getRegionHeight() != bottomHeight)
            ...
            throw new KermanRuntimeException("Bottom side patches must have the same height");
        }
        if ((patches[TOP_LEFT] != null && patches[TOP_LEFT].getRegionHeight() != topHeight)
            ...
            throw new KermanRuntimeException("Top side patches must have the same height");
        }
    }

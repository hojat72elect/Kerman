...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g2d.ParticleEffect".
 */
public class ParticleEffect implements Disposable {
    private final KermanArray<ParticleEmitter> emitters;
    ...
    public ParticleEffect() {
        emitters = new KermanArray<>(8);
    }

    public ParticleEffect(ParticleEffect effect) {
        emitters = new KermanArray<>(true, effect.emitters.size);
    ...
    public KermanArray<ParticleEmitter> getEmitters() {
        return emitters;
    }
    ...
    /**
     * Allocates all emitters particles. See {@link com.kerman.core.graphics.k2d.ParticleEmitter#preAllocateParticles()}
     */
    ...
    public void loadEmitters(FileHandle effectFile) {
        ...
        try {
            ...
            throw new KermanRuntimeException("Error loading effect: " + effectFile, ex);
        } finally {
    ...
    public void loadEmitterImages(TextureAtlas atlas, String atlasPrefix) {
        for (int i = 0, n = emitters.size; i < n; i++) {
            ...
            KermanArray<Sprite> sprites = new KermanArray<>();
    ...
    /**
     * Sets the {@link com.kerman.core.graphics.k2d.ParticleEmitter#setCleansUpBlendFunction(boolean) cleansUpBlendFunction}
     * parameter on all {@link com.kerman.core.graphics.k2d.ParticleEmitter ParticleEmitters} currently in this ParticleEffect.
     * <p>

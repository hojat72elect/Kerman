...
import com.kerman.core.graphics.Colors;
import com.kerman.core.graphics.k2d.BitmapFont.BitmapFontData;
import com.kerman.core.graphics.k2d.BitmapFont.Glyph;
import com.kerman.core.utils.Align;
import com.kerman.core.utils.KermanArray;
import com.kerman.core.utils.DefaultPool;
...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g2d.GlyphLayout".
 * <p>
 * Stores {@link GlyphRun runs} of glyphs for a piece of text. The text may contain newlines and color markup tags.
 * <p>
 * Where wrapping occurs is determined by {@link BitmapFontData#getWrapIndex(KermanArray, int)}. Additionally, when
...
public class GlyphLayout implements Poolable {
    ...
    static private final KermanIntArray colorStack = new KermanIntArray(4);
     ...
     */
    public final KermanArray<GlyphRun> runs = new KermanArray(1);
     ...
     */
    public final KermanIntArray colors = new KermanIntArray(2);
    ...
    private GlyphRun wrap(BitmapFontData fontData, GlyphRun first, int wrapIndex) {
        KermanArray<Glyph> glyphs2 = first.glyphs; // Starts with all the glyphs.
        int glyphCount = first.glyphs.size;
        KermanFloatArray xAdvances2 = first.xAdvances; // Starts with all the xadvances.
        ...
        if (secondStart < glyphCount) {
            ...
            KermanArray<Glyph> glyphs1 = second.glyphs; // Starts empty.
            glyphs1.addAll(glyphs2, 0, firstEnd);
            glyphs2.removeRange(0, secondStart - 1);
            first.glyphs = glyphs1;
            second.glyphs = glyphs2;

            KermanFloatArray xAdvances1 = second.xAdvances; // Starts empty.
     ...
     */
    private float getLineOffset(KermanArray<Glyph> glyphs, BitmapFontData fontData) {
    ...
    static public class GlyphRun implements Poolable {
        public KermanArray<Glyph> glyphs = new KermanArray();
         ...
         */
        public KermanFloatArray xAdvances = new KermanFloatArray();
        ...
        public String toString() {
            ...
            KermanArray<Glyph> glyphs = this.glyphs;

...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g2d.ParticleEmitter".
 */
public class ParticleEmitter {
    ...
    public ParticleEmitter(ParticleEmitter emitter) {
        sprites = new KermanArray<>(emitter.sprites);
        name = emitter.name;
        imagePaths = new KermanArray<>(emitter.imagePaths);
    ...
    private void initialize() {
        sprites = new KermanArray<>();
        imagePaths = new KermanArray<>();
    ...
    public void draw(Batch batch) {
        if (premultipliedAlpha) {
            batch.setBlendFunction(GLES20.GL_ONE, GLES20.GL_ONE_MINUS_SRC_ALPHA);
        } else if (additive) {
            batch.setBlendFunction(GLES20.GL_SRC_ALPHA, GLES20.GL_ONE);
        } else {
            batch.setBlendFunction(GLES20.GL_SRC_ALPHA, GLES20.GL_ONE_MINUS_SRC_ALPHA);
        }
        Particle[] particles = this.particles;
        boolean[] active = this.active;
     ...
     * {@link #setSprites(KermanArray)} must have been set before calling this method
     */
    ...
    public KermanArray<Sprite> getSprites() {
        return sprites;
    }

    public void setSprites(KermanArray<Sprite> sprites) {
    ...
    /**
     * @return Whether this ParticleEmitter automatically returns the {@link com.kerman.core.graphics.k2d.Batch Batch}'s blend
    ...
    /**
     * Set whether to automatically return the {@link com.kerman.core.graphics.k2d.Batch Batch}'s blend function to the
    ...
    public KermanArray<String> getImagePaths() {
        return imagePaths;
    }

    public void setImagePaths(KermanArray<String> imagePaths) {
    ...
    public void load(BufferedReader reader) throws IOException {
        try {
            ...
            KermanArray<String> imagePaths = new KermanArray<>();
    ...
    static public class IndependentScaledNumericValue extends ScaledNumericValue {
        ...
        public void load(BufferedReader reader) throws IOException {
            ...
            if (line.contains("independent"))
                ...
                Kerman.app.error("ParticleEmitter", errorMessage);

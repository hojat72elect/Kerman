...
import com.kerman.core.utils.Collections;
import com.kerman.core.utils.KermanRuntimeException;
import java.util.Iterator;
import java.util.NoSuchElementException;

/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.VertexAttributes".
 * <p>
...
public final class VertexAttributes implements Iterable<VertexAttribute>, Comparable<VertexAttributes> {
    ...
    static private class ReadonlyIterator<T> implements Iterator<T>, Iterable<T> {
        ...
        @Override
        public void remove() {
            throw new KermanRuntimeException("Remove not allowed.");
        }

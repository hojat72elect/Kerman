...
import com.kerman.core.assets.loaders.CubemapLoader.CubemapParameter;
import com.kerman.core.files.FileHandle;
import com.kerman.core.graphics.Pixmap.Format;
import com.kerman.core.graphics.glutils.FacedCubemapData;
...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.Cubemap".
 *
 * Wraps a standard OpenGL ES Cubemap. Must be disposed when it is no longer used.
 */
public class Cubemap extends GLTexture {
    final static Map<Application, KermanArray<Cubemap>> managedCubemaps = new HashMap<>();
    ...
    public Cubemap(CubemapData data) {
        ...
        this.data = data;
        load(data);
        if (data.isManaged()) addManagedCubemap(Kerman.app, this);
    }
    ...
    private static void addManagedCubemap(Application app, Cubemap cubemap) {
        KermanArray<Cubemap> managedCubemapArray = managedCubemaps.get(app);
        if (managedCubemapArray == null) managedCubemapArray = new KermanArray<>();
    ...
    public static void invalidateAllCubemaps(Application app) {
        ...
        if (assetManager == null) {
            ...
            // asset manager.
            KermanArray<Cubemap> cubemaps = new KermanArray<>(managedCubemapArray);
            for (Cubemap cubemap : cubemaps) {
                ...
                if (fileName == null) {
                    ...
                    cubemap.glHandle = Kerman.gl.glGenTexture();
    ...
    public static int getNumManagedCubemaps() {
        return managedCubemaps.get(Kerman.app).size;
    }
    ...
    protected void reload() {
        if (!isManaged()) throw new KermanRuntimeException("Tried to reload an unmanaged Cubemap");
    ...
    public void dispose() {
        ...
        delete();
        if (data.isManaged()) if (managedCubemaps.get(Kerman.app) != null) managedCubemaps.get(Kerman.app).removeValue(this, true);
    }

...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.VertexAttribute".
 * <p>
...
public final class VertexAttribute {
    ...
    public VertexAttribute(int usage, int numComponents, String alias, int unit) {
        this(usage, numComponents, usage == Usage.ColorPacked ? GLES20.GL_UNSIGNED_BYTE : GLES20.GL_FLOAT, usage == Usage.ColorPacked,
                alias, unit);
    }
     ...
     * @param numComponents the number of components of this attribute, must be between 1 and 4.
     * @param type          the OpenGL type of each component, e.g. {@link GLES20#GL_FLOAT} or {@link GLES20#GL_UNSIGNED_BYTE}. Since

...
import com.kerman.core.graphics.Cubemap.CubemapSide;
...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.glutils.FacedCubemapData".
 * <p>
...
public class FacedCubemapData implements CubemapData {
    ...
    @Override
    public void prepare() {
        if (!isComplete()) throw new KermanRuntimeException("You need to complete your cubemap data before using it");
    ...
    public void consumeCubemapData() {
        for (int i = 0; i < data.length; i++) {
            if (data[i].getType() == TextureData.TextureDataType.Custom) {
                ...
                Kerman.gl.glTexImage2D(GLES20.GL_TEXTURE_CUBE_MAP_POSITIVE_X + i, 0, pixmap.getGLInternalFormat(), pixmap.getWidth(),

...
/**
 * This class was inspired by "com.badlogic.gdx.graphics.glutils.GLVersion".
 */
public class GLVersion {
    ...
    private void extractVersion(String patternString, String versionString) {
        ...
        if (found) {
            ...
            Kerman.app.log(TAG, "Invalid version string: " + versionString);
            majorVersion = 2;
            minorVersion = 0;
            releaseVersion = 0;
        }
    ...
    private int parseInt(String v, int defaultValue) {
        try {
            ...
            Kerman.app.error("libGDX GL", "Error parsing number: " + v + ", assuming: " + defaultValue);
            return defaultValue;
        }
    }

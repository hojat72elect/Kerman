...
/**
 * This class was inspired by "com.badlogic.gdx.graphics.glutils.PixmapTextureData".
 */
public class PixmapTextureData implements TextureData {
    ...
    @Override
    public void prepare() {
        throw new KermanRuntimeException("prepare() must not be called on a PixmapTextureData instance as it is already prepared.");
    }
}

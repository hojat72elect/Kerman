...
import com.kerman.core.graphics.PixmapIO;
import com.kerman.core.graphics.TextureData;
import com.kerman.core.utils.KermanRuntimeException;

/**
 * Info : This class was inspired by the "com.badlogic.gdx.graphics.glutils.FileTextureData".
 */
public class FileTextureData implements TextureData {
    ...
    public Pixmap consumePixmap() {
        if (!isPrepared) throw new KermanRuntimeException("Call prepare() before calling getPixmap()");
        isPrepared = false;
    ...
    public void consumeCustomData(int target) {
        throw new KermanRuntimeException("This TextureData implementation does not upload data itself");
    }

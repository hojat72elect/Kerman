...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.glutils.IndexBufferObject".
 * <p>
 * The IndexBufferObject wraps OpenGL's index buffer functionality to be used in conjunction with VBOs. This class can be
...
public class IndexBufferObject implements IndexData {
    ...
    public void setIndices(@NotNull short[] indices, int offset, int count) {
        ...
        if (isBound) {
            Kerman.gl20.glBufferData(GLES20.GL_ELEMENT_ARRAY_BUFFER, byteBuffer.limit(), byteBuffer, usage);
            isDirty = false;
        }
    }
     ...
     */
    public void bind() {
        if (bufferHandle == 0) throw new KermanRuntimeException("No buffer allocated!");
    ...
    public void dispose() {
        Kerman.gl20.glBindBuffer(GLES20.GL_ELEMENT_ARRAY_BUFFER, 0);
        Kerman.gl20.glDeleteBuffer(bufferHandle);
        bufferHandle = 0;

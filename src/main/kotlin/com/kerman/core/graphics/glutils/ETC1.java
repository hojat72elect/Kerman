...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.glutils.ETC1".
 * <p>
...
public class ETC1 {
    ...
    private static int getPixelSize(Format format) {
        ...
        throw new KermanRuntimeException("Can only handle RGB565 or RGB888 images");
    }
    ...
    public final static class ETC1Data implements Disposable {
        ...
        public ETC1Data(FileHandle pkmFile) {
            ...
            try {
                ...
                throw new KermanRuntimeException("Couldn't load pkm file '" + pkmFile + "'", e);
            } finally {
        ...
        public void write(FileHandle file) {
            ...
            try {
                ...
                throw new KermanRuntimeException("Couldn't write PKM file to '" + file + "'", e);
            } finally {

...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.glutils.FrameBuffer".
 * <p>
...
public class FrameBuffer extends GLFrameBuffer<Texture> {
    ...
    protected Texture createTexture(FrameBufferTextureAttachmentSpec attachmentSpec) {
        ...
        boolean webGLDepth = attachmentSpec.isDepth && Kerman.app.getType() == Application.ApplicationType.WebGL;
        if (!webGLDepth) {
    ...
    protected void attachFrameBufferColorTexture(Texture texture) {
        Kerman.gl20.glFramebufferTexture2D(GLES20.GL_FRAMEBUFFER, GLES20.GL_COLOR_ATTACHMENT0, GLES20.GL_TEXTURE_2D,

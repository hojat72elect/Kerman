...
import com.kerman.core.math.Frustum;
import com.kerman.core.math.Matrix4;
import com.kerman.core.math.Quaternion;
import com.kerman.core.math.Vector3;
import com.kerman.core.math.collision.Ray;

/**
 * Info : This abstract class was inspired by "com.badlogic.gdx.graphics.Camera".
 * <p>
...
public abstract class Camera {
     ...
     * viewport position and dimensions in the coordinate system expected by {@link GLES20#glViewport(int, int, int, int)}, with the
    ...
    public Vector3 unproject(Vector3 touchCoords, float viewportX, float viewportY, float viewportWidth, float viewportHeight) {
        float x = touchCoords.x - viewportX, y = Kerman.graphics.getHeight() - touchCoords.y - viewportY;
    ...
    public Vector3 unproject(Vector3 touchCoords) {
        unproject(touchCoords, 0, 0, Kerman.graphics.getWidth(), Kerman.graphics.getHeight());
        return touchCoords;
    }
    ...
    public Vector3 project(Vector3 worldCoords) {
        project(worldCoords, 0, 0, Kerman.graphics.getWidth(), Kerman.graphics.getHeight());
        return worldCoords;
    }
     ...
     * dimensions in the coordinate system expected by {@link GLES20#glViewport(int, int, int, int)}, with the origin in the bottom
    ...
    public Ray getPickRay(float touchX, float touchY) {
        return getPickRay(touchX, touchY, 0, 0, Kerman.graphics.getWidth(), Kerman.graphics.getHeight());
    }
}

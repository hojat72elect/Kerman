...
/**
 * This interface was inspired by "com.badlogic.gdx.graphics.GL20".
 *
 * A wrapper for all the methods of OpenGL ES 2.0.
 *
 * This is the universal baseline standard for mobile, and also WebGL 1.0. This version removed "fixed-function pipeline" entirely, forcing developers to
 * use shaders. It is also the basis for WebGL 1.0.
 */
interface GLES20 {

...
import com.kerman.core.utils.ArraySupplier;
...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g3d.particles.ParallelArray".
 * <p>
 * This class represents a group of elements like an array, but the properties of the elements are stored as separate arrays.
...
public class ParallelArray {
     ...
     */
    KermanArray<Channel> arrays;

    public ParallelArray(int capacity) {
        arrays = new KermanArray<>(false, 2, Channel[]::new);
    ...
    public void addElement(Object... values) {
        /* FIXME make it grow... */
        if (size == capacity) throw new KermanRuntimeException("Capacity reached, cannot add other elements");

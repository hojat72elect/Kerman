...
import com.kerman.core.graphics.Mesh;
...
import com.kerman.core.graphics.k3d.attributes.ColorAttribute;
...
import com.kerman.core.graphics.k3d.model.Animation;
import com.kerman.core.graphics.k3d.model.MeshPart;
import com.kerman.core.graphics.k3d.model.Node;
import com.kerman.core.graphics.k3d.model.NodeAnimation;
import com.kerman.core.graphics.k3d.model.NodeKeyframe;
import com.kerman.core.graphics.k3d.model.NodePart;
...
import com.kerman.core.graphics.k3d.utils.TextureProvider;
import com.kerman.core.graphics.k3d.utils.TextureProvider.FileTextureProvider;
 ...
 * <p>
 * A model represents a 3D asset. It stores a hierarchy of nodes. A node has a transform and optionally a graphical part in form
...
public class Model implements Disposable {
     ...
     **/
    public final KermanArray<Material> materials = new KermanArray<>();
    /**
     * root nodes of the model
     **/
    public final KermanArray<Node> nodes = new KermanArray<>();
    /**
     * animations of the model, modifying node transformations
     **/
    public final KermanArray<Animation> animations = new KermanArray<>();
    /**
     * the meshes of the model
     **/
    public final KermanArray<Mesh> meshes = new KermanArray<>();
    /**
     ...
     **/
    public final KermanArray<MeshPart> meshParts = new KermanArray<>();
    /**
     * Array of disposable resources like textures or meshes the Model is responsible for disposing
     **/
    protected final KermanArray<Disposable> disposables = new KermanArray<>();
    ...
    protected Node loadNode(ModelNode modelNode) {
        ...
        if (modelNode.parts != null) {
            for (ModelNodePart modelNodePart : modelNode.parts) {
                ...
                if (meshPart == null || meshMaterial == null) throw new KermanRuntimeException("Invalid node: " + node.id);
    ...
    protected Material convertMaterial(ModelMaterial mtl, TextureProvider textureProvider) {
        ...
        if (mtl.opacity != 1.f) result.set(new BlendingAttribute(GLES20.GL_SRC_ALPHA, GLES20.GL_ONE_MINUS_SRC_ALPHA, mtl.opacity));

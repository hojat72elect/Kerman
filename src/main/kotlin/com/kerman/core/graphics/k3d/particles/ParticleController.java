...
import com.kerman.core.graphics.k3d.particles.emitters.Emitter;
import com.kerman.core.graphics.k3d.particles.influencers.Influencer;
import com.kerman.core.graphics.k3d.particles.renderers.ParticleControllerRenderer;
...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g3d.particles.ParticleController".
 * <p>
...
public class ParticleController implements Json.Serializable, ResourceData.Configurable {
     ...
     */
    public KermanArray<Influencer> influencers;
    ...
    public ParticleController() {
        ...
        influencers = new KermanArray<>(true, 3, Influencer[]::new);
    ...
    public ParticleController(String name, Emitter emitter, ParticleControllerRenderer<?, ?> renderer,
        ...
        this.influencers = new KermanArray<Influencer>(influencers);
    }
     ...
     */
    public void update() {
        update(Kerman.graphics.getDeltaTime());
    }
    ...
    public void write(Json json) {
        ...
        json.writeValue("influencers", influencers, KermanArray.class, Influencer.class);
    ...
    public void read(Json json, JsonValue jsonMap) {
        ...
        influencers.addAll(json.readValue("influencers", KermanArray.class, Influencer.class, jsonMap));

...
import com.kerman.core.graphics.k3d.Environment;
...
import com.kerman.core.graphics.k3d.attributes.CubemapAttribute;
import com.kerman.core.graphics.k3d.attributes.DepthTestAttribute;
...
import com.kerman.core.graphics.k3d.attributes.IntAttribute;
...
import com.kerman.core.graphics.k3d.environment.AmbientCubemap;
...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g3d.shaders.DefaultShader".
 */
public class DefaultShader extends BaseShader {
     ...
     */
    @Deprecated
    public static int defaultCullFace = GLES20.GL_BACK;
    /**
     * @deprecated Replaced by {@link Config#defaultDepthFunc} Set to 0 to disable depth test
     */
    @Deprecated
    public static int defaultDepthFunc = GLES20.GL_LEQUAL;
    ...
    public DefaultShader(final Renderable renderable, final Config config, final ShaderProgram shaderProgram) {
        ...
        if (!config.ignoreUnimplemented && (implementedFlags & attributesMask) != attributesMask)
            throw new KermanRuntimeException("Some attributes not implemented yet (" + attributesMask + ")");
    ...
    public static String getDefaultVertexShader() {
        if (defaultVertexShader == null)
            defaultVertexShader = Kerman.files.classpath("com/badlogic/gdx/graphics/g3d/shaders/default.vertex.glsl").readString();
        return defaultVertexShader;
    }

    public static String getDefaultFragmentShader() {
        if (defaultFragmentShader == null)
            defaultFragmentShader = Kerman.files.classpath("com/badlogic/gdx/graphics/g3d/shaders/default.fragment.glsl").readString();
    ...
    public void begin(@NotNull final Camera camera, @NotNull final RenderContext context) {
        ...
        if (has(u_time)) set(u_time, time += Kerman.graphics.getDeltaTime());
        ...
        if (boneWeightsLocations != null) {
            for (int location : boneWeightsLocations) {
                if (location >= 0) {
                    Kerman.gl.glVertexAttrib2f(location, 0, 0);
                }
            }
        }
    }
    ...
    public void render(Renderable renderable, Attributes combinedAttributes) {
        if (!combinedAttributes.has(BlendingAttribute.Type))
            context.setBlending(false, GLES20.GL_SRC_ALPHA, GLES20.GL_ONE_MINUS_SRC_ALPHA);
    ...
    protected void bindMaterial(final Attributes attributes) {
        ...
        for (final Attribute attr : attributes) {
            ...
            if (BlendingAttribute.is(t)) {
                ...
                throw new KermanRuntimeException("Unknown material attribute: " + attr);
        }
            ...
            public void set(BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
                if (renderable.environment == null)
                    ...
                    if (combinedAttributes.has(DirectionalLightsAttribute.Type)) {
                        KermanArray<DirectionalLight> lights = ((DirectionalLightsAttribute) combinedAttributes
                    ...
                    if (combinedAttributes.has(PointLightsAttribute.Type)) {
                        KermanArray<PointLight> lights = ((PointLightsAttribute) combinedAttributes.get(PointLightsAttribute.Type)).lights;

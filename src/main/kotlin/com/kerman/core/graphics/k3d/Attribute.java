...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g3d.Attribute".
 * <p>
 * Extend this class to implement a material attribute. Register the attribute type by statically calling the
 * {@link #register(String)} function, whose return value should be used to instantiate the attribute. A class can implement
 * multiple types.
 */
public abstract class Attribute implements Comparable<Attribute> {
     ...
     */
    private final static KermanArray<String> types = new KermanArray<>();
     ...
     * @throws KermanRuntimeException if maximum attribute count reached
     */
    protected final static long register(final String alias) {
        ...
        if (types.size >= MAX_ATTRIBUTE_COUNT) {
            throw new KermanRuntimeException("Cannot register " + alias + ", maximum registered attribute count reached.");
        }
        types.add(alias);

...
/**
 * Info : This class was inspired by the "com.badlogic.gdx.graphics.g3d.Material".
 */
public class Material extends Attributes {
     ...
     * Create a material with the specified attributes
     */
    public Material(final KermanArray<Attribute> attributes) {
        this();
        set(attributes);
    }
     ...
     * Create a material with the specified attributes
     */
    public Material(final String id, final KermanArray<Attribute> attributes) {
        this(id);
        set(attributes);
    }

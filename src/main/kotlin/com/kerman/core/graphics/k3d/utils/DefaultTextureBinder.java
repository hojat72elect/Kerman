...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g3d.utils.DefaultTextureBinder".
 * <p>
...
public final class DefaultTextureBinder implements TextureBinder {
    ...
    public DefaultTextureBinder(final int method, final int offset, int count) {
        ...
        if (offset < 0 || count < 0 || (offset + count) > max) throw new KermanRuntimeException("Illegal arguments");
        this.method = method;
        this.offset = offset;
        this.count = count;
    ...
    private static int getMaxTextureUnits() {
        ...
        Kerman.gl.glGetIntegerv(GLES20.GL_MAX_TEXTURE_IMAGE_UNITS, buffer);
        return buffer.get(0);
    }
    ...
    public void end() {
         ...
         * }
         */
        Kerman.gl.glActiveTexture(GLES20.GL_TEXTURE0);
    }
    ...
    private int bindTexture(final TextureDescriptor textureDesc, final boolean rebind) {
        ...
        if (reused) {
            ...
            if (rebind)
                ...
                Kerman.gl.glActiveTexture(GLES20.GL_TEXTURE0 + result);
        } else
            bindCount++;

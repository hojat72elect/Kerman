package com.kerman.core.graphics.k3d.loader;
...
import com.kerman.core.graphics.k3d.model.data.ModelAnimation;
import com.kerman.core.graphics.k3d.model.data.ModelData;
import com.kerman.core.graphics.k3d.model.data.ModelMaterial;
import com.kerman.core.graphics.k3d.model.data.ModelMesh;
import com.kerman.core.graphics.k3d.model.data.ModelMeshPart;
import com.kerman.core.graphics.k3d.model.data.ModelNode;
import com.kerman.core.graphics.k3d.model.data.ModelNodeAnimation;
import com.kerman.core.graphics.k3d.model.data.ModelNodeKeyframe;
import com.kerman.core.graphics.k3d.model.data.ModelNodePart;
import com.kerman.core.graphics.k3d.model.data.ModelTexture;
...
import com.kerman.core.utils.BaseJsonReader;
import com.kerman.core.utils.KermanRuntimeException;
import com.kerman.core.utils.JsonValue;

/**
 * Info : This class was inspired by : "com.badlogic.gdx.graphics.g3d.loader.G3dModelLoader"
 */
public class K3dModelLoader extends ModelLoader<ModelLoader.ModelParameters> {
    public static final short VERSION_HI = 0;
    public static final short VERSION_LO = 1;
    protected final BaseJsonReader reader;
    protected final Quaternion tempQ = new Quaternion();

    public K3dModelLoader(final BaseJsonReader reader) {
        this(reader, null);
    }

    public K3dModelLoader(BaseJsonReader reader, FileHandleResolver resolver) {
        super(resolver);
        this.reader = reader;
    }
    ...
    public ModelData parseModel(FileHandle handle) {
        ...
        if (model.version[0] != VERSION_HI || model.version[1] != VERSION_LO)
            throw new KermanRuntimeException("Model version not supported");
    ...
    protected void parseMeshes(ModelData model, JsonValue json) {
        ...
        if (meshes != null) {
            ...
            for (JsonValue mesh = meshes.child; mesh != null; mesh = mesh.next) {
                ...
                KermanArray<ModelMeshPart> parts = new KermanArray<>();
                for (JsonValue meshPart = meshParts.child; meshPart != null; meshPart = meshPart.next) {
                    ...
                    if (partId == null) {
                        throw new KermanRuntimeException("Not id given for mesh part");
                    }
                    for (ModelMeshPart other : parts) {
                        if (other.id.equals(partId)) {
                            throw new KermanRuntimeException("Mesh part with id '" + partId + "' already in defined");
                        }
                    }
                    jsonPart.id = partId;
                    ...
                    if (type == null) {
                        throw new KermanRuntimeException("No primitive type given for mesh part '" + partId + "'");
                    }
    ...
    protected VertexAttribute[] parseAttributes(JsonValue attributes) {
        KermanArray<VertexAttribute> vertexAttributes = new KermanArray<>();
        int unit = 0;
    ...
    protected void parseMaterials(ModelData model, JsonValue json, String materialDir) {
        ...
        if (materials == null) {
            ...
            for (JsonValue material = materials.child; material != null; material = material.next) {
                ...
                if (id == null) throw new KermanRuntimeException("Material needs an id.");
                ...
                if (textures != null) {
                    for (JsonValue texture = textures.child; texture != null; texture = texture.next) {
                        ...
                        if (textureId == null) throw new KermanRuntimeException("Texture has no id.");
                        jsonTexture.id = textureId;

                        String fileName = texture.getString("filename", null);
                        if (fileName == null) throw new KermanRuntimeException("Texture needs filename.");
                        ...
                        if (textureType == null) throw new KermanRuntimeException("Texture needs type.");

                        jsonTexture.usage = parseTextureUsage(textureType);

                        if (jsonMaterial.textures == null) jsonMaterial.textures = new KermanArray<>();
    ...
    protected Color parseColor(JsonValue colorArray) {
        if (colorArray.size >= 3)
            ...
            throw new KermanRuntimeException("Expected Color values <> than three.");
    }
    ...
    protected Vector2 readVector2(JsonValue vectorArray, float x, float y) {
        if (vectorArray == null)
            ...
            throw new KermanRuntimeException("Expected Vector2 values <> than two.");
    }

    protected KermanArray<ModelNode> parseNodes(ModelData model, JsonValue json) {
    ...
    protected ModelNode parseNodesRecursively(JsonValue json) {
        ...
        if (id == null) throw new KermanRuntimeException("Node id missing.");
        jsonNode.id = id;

        JsonValue translation = json.get("translation");
        if (translation != null && translation.size != 3) throw new KermanRuntimeException("Node translation incomplete");
        ...
        if (rotation != null && rotation.size != 4) throw new KermanRuntimeException("Node rotation incomplete");
        ...
        if (scale != null && scale.size != 3) throw new KermanRuntimeException("Node scale incomplete");
        ...
        if (materials != null) {
            ...
            for (JsonValue material = materials.child; material != null; material = material.next, i++) {
                ...
                if (meshPartId == null || materialId == null) {
                    throw new KermanRuntimeException("Node " + id + " part is missing meshPartId or materialId");
                }
                ...
                if (bones != null) {
                    ...
                    for (JsonValue bone = bones.child; bone != null; bone = bone.next, j++) {
                        ...
                        if (nodeId == null) throw new KermanRuntimeException("Bone node ID missing");
                ...
                if (keyframes != null && keyframes.isArray()) {
                    for (JsonValue keyframe = keyframes.child; keyframe != null; keyframe = keyframe.next) {
                        ...
                        if (translation != null && translation.size == 3) {
                            if (nodeAnim.translation == null) nodeAnim.translation = new KermanArray<>();
                        ...
                        if (rotation != null && rotation.size == 4) {
                            if (nodeAnim.rotation == null) nodeAnim.rotation = new KermanArray<>();
                        ...
                        if (scale != null && scale.size == 3) {
                            if (nodeAnim.scaling == null) nodeAnim.scaling = new KermanArray<>();
                    ...
                    if (translationKF != null && translationKF.isArray()) {
                        nodeAnim.translation = new KermanArray<>();
                    ...
                    if (rotationKF != null && rotationKF.isArray()) {
                        nodeAnim.rotation = new KermanArray<>();
                    ...
                    if (scalingKF != null && scalingKF.isArray()) {
                        nodeAnim.scaling = new KermanArray<>();

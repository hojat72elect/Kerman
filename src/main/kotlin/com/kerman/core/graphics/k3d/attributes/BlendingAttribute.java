...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g3d.attributes.BlendingAttribute".
 */
public class BlendingAttribute extends Attribute {
    ...
    public BlendingAttribute(final boolean blended, final float opacity) {
        this(blended, GLES20.GL_SRC_ALPHA, GLES20.GL_ONE_MINUS_SRC_ALPHA, opacity);
    }
    ...
    public BlendingAttribute(final BlendingAttribute copyFrom) {
        this(copyFrom == null || copyFrom.blended, copyFrom == null ? GLES20.GL_SRC_ALPHA : copyFrom.sourceFunction,
                copyFrom == null ? GLES20.GL_ONE_MINUS_SRC_ALPHA : copyFrom.destFunction, copyFrom == null ? 1.f : copyFrom.opacity);
    }

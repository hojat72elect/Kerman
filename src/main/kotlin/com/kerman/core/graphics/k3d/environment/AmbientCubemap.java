...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g3d.environment.AmbientCubemap".
 */
public class AmbientCubemap {
    ...
    public AmbientCubemap(final float[] copyFrom) {
        if (copyFrom.length != (NUM_VALUES)) throw new KermanRuntimeException("Incorrect array size");

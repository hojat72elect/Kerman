...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g3d.environment.SphericalHarmonics".
 */
public class SphericalHarmonics {
    ...
    public SphericalHarmonics(final float[] copyFrom) {
        if (copyFrom.length != (9 * 3)) throw new KermanRuntimeException("Incorrect array size");
        data = copyFrom.clone();
    }

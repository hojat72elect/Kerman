...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g3d.Attributes".
 */
public class Attributes implements Iterable<Attribute>, Comparator<Attribute>, Comparable<Attributes> {
    protected final KermanArray<Attribute> attributes = new KermanArray<Attribute>();
    protected long mask;
     ...
     */
    public final KermanArray<Attribute> get(final KermanArray<Attribute> out, final long type) {
    ...
    @Override
    public int compareTo(@NotNull Attributes other) {

...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g3d.ModelInstance".
 * <p>
 * This is an instance of a {@link Model}, which allows to specify global transform and modify the materials, as it has a copy of the model's
...
public class ModelInstance implements RenderableProvider {
     ...
     * Constructs a new ModelInstance with only the specified nodes and materials of the given model.
     */
    public ModelInstance(final Model model, final KermanArray<String> rootNodeIds) {
        this(model, null, rootNodeIds);
    }
     ...
     * Constructs a new ModelInstance with only the specified nodes and materials of the given model.
     */
    public ModelInstance(final Model model, final Matrix4 transform, final KermanArray<String> rootNodeIds) {
     ...
     * Constructs a new ModelInstance with only the specified nodes and materials of the given model.
     */
    public ModelInstance(final Model model, final Matrix4 transform, final KermanArray<String> rootNodeIds, boolean shareKeyframes) {
        this.model = model;
        this.transform = transform == null ? new Matrix4() : transform;
        copyNodes(model.nodes, rootNodeIds);
        copyAnimations(model.animations, shareKeyframes);
    ...
    private void copyNodes(KermanArray<Node> nodes) {
    ...
    private void copyNodes(KermanArray<Node> nodes, final String... nodeIds) {
        for (int i = 0, n = nodes.size; i < n; ++i) {
            final Node node = nodes.get(i);
    ...
    private void copyNodes(KermanArray<Node> nodes, final KermanArray<String> nodeIds) {
        for (int i = 0, n = nodes.size; i < n; ++i) {
            final Node node = nodes.get(i);
            for (final String nodeId : nodeIds) {
                if (nodeId.equals(node.id)) {
     ...
     */
    public void getRenderables(@NotNull KermanArray<Renderable> renderables, @NotNull Pool<Renderable> pool) {
        for (Node node : nodes) {
    ...
    protected void getRenderables(Node node, KermanArray<Renderable> renderables, Pool<Renderable> pool) {

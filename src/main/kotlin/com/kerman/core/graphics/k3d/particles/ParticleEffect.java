...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g3d.particles.ParticleEffect".
 * <p>
 * It's a set of particle controllers. It can be updated, rendered, transformed which means the changes will be applied on all
 * the particles controllers.
 */
public class ParticleEffect implements Disposable, ResourceData.Configurable {
    private final KermanArray<ParticleController> controllers;
    private BoundingBox bounds;

    public ParticleEffect() {
        controllers = new KermanArray<>(true, 3, ParticleController[]::new);
    }

    public ParticleEffect(ParticleEffect effect) {
        controllers = new KermanArray<>(true, effect.controllers.size);
    ...
    public ParticleEffect(ParticleController... emitters) {
        this.controllers = new KermanArray<>(emitters);
    }
     ...
     */
    public KermanArray<ParticleController> getControllers() {
        return controllers;
    }
     ...
     * assigned.
     */
    public void setBatch(KermanArray<ParticleBatch<?>> batches) {

...
import com.kerman.core.graphics.k3d.utils.DefaultRenderableSorter;
import com.kerman.core.graphics.k3d.utils.DefaultShaderProvider;
import com.kerman.core.graphics.k3d.utils.DefaultTextureBinder;
import com.kerman.core.graphics.k3d.utils.RenderContext;
import com.kerman.core.graphics.k3d.utils.RenderableSorter;
import com.kerman.core.graphics.k3d.utils.ShaderProvider;
...
/**
 * Info : This class was inspired by "com.badlogic.gdx.graphics.g3d.ModelBatch".
 * <p>
...
public class ModelBatch implements Disposable {
     ...
     **/
    protected final KermanArray<Renderable> renderables = new KermanArray<>();
    /**
    ...
    public void begin(final Camera cam) {
        if (camera != null) throw new KermanRuntimeException("Call end() first.");
        camera = cam;
    ...
    public void setCamera(final Camera cam) {
        if (camera == null) throw new KermanRuntimeException("Call begin() first.");
    ...
    /**
     * Calls {@link RenderableProvider#getRenderables(KermanArray, Pool)} and adds all returned {@link Renderable} instances to the
